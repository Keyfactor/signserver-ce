...
public class ChartDataSourceHasLabelsAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.CHART), "data-source-has-labels" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of chart:data-source-has-labels is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute chart:data-source-has-labels} dependent of its element name
	 * 
