...
public class ChartErrorCategoryAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.CHART), "error-category" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of chart:error-category is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute chart:error-category} dependent of its element name
	 * 
