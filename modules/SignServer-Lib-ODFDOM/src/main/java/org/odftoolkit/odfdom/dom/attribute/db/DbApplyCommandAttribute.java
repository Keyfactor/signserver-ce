...
public class DbApplyCommandAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "apply-command" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of db:apply-command is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute db:apply-command} dependent of its element name
	 * 
