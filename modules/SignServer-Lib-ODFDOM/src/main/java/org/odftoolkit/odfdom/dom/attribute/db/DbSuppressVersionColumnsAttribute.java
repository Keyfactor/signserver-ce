...
public class DbSuppressVersionColumnsAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "suppress-version-columns" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of db:suppress-version-columns is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute db:suppress-version-columns} dependent of its element name
	 * 
