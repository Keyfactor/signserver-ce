...
public class DrawDisplayAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "display" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of draw:display is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute draw:display} dependent of its element name
	 * 
