...
public class DrawExtrusionLightFaceAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "extrusion-light-face" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of draw:extrusion-light-face is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute draw:extrusion-light-face} dependent of its element name
	 * 
