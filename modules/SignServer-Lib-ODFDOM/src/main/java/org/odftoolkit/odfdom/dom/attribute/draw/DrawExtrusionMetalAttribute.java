...
public class DrawExtrusionMetalAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "extrusion-metal" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of draw:extrusion-metal is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute draw:extrusion-metal} dependent of its element name
	 * 
