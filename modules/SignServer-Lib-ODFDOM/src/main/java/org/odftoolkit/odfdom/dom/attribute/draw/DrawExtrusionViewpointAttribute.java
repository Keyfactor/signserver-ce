...
public class DrawExtrusionViewpointAttribute extends OdfAttribute {
	...
	public void setValue(String attrValue) {
		try{
			//2DO: need validate value against Point3D
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of draw:extrusion-viewpoint is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute draw:extrusion-viewpoint} dependent of its element name
	 * 
