...
public class DrawPathStretchpointYAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "path-stretchpoint-y" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of draw:path-stretchpoint-y is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute draw:path-stretchpoint-y} dependent of its element name
	 * 
