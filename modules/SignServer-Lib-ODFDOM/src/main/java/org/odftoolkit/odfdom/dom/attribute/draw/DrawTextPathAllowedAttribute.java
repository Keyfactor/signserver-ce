...
public class DrawTextPathAllowedAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "text-path-allowed" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of draw:text-path-allowed is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute draw:text-path-allowed} dependent of its element name
	 * 
