...
public class DrawTextPathSameLetterHeightsAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "text-path-same-letter-heights" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of draw:text-path-same-letter-heights is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute draw:text-path-same-letter-heights} dependent of its element name
	 * 
