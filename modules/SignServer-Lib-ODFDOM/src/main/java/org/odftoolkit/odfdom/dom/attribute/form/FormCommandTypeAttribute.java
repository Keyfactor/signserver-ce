...
public class FormCommandTypeAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "command-type" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of form:command-type is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute form:command-type} dependent of its element name
	 * 
