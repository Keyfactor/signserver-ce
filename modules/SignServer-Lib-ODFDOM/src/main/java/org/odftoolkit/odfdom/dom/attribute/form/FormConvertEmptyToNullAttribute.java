...
public class FormConvertEmptyToNullAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "convert-empty-to-null" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of form:convert-empty-to-null is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute form:convert-empty-to-null} dependent of its element name
	 * 
