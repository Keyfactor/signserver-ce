...
public class FormValidationAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "validation" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of form:validation is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute form:validation} dependent of its element name
	 * 
