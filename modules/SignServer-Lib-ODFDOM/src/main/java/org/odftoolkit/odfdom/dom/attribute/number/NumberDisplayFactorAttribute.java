...
public class NumberDisplayFactorAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.NUMBER), "display-factor" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of number:display-factor is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute number:display-factor} dependent of its element name
	 * 
