...
public class NumberGroupingAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.NUMBER), "grouping" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of number:grouping is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute number:grouping} dependent of its element name
	 * 
