...
public class PresentationNodeTypeAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.PRESENTATION), "node-type" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of presentation:node-type is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute presentation:node-type} dependent of its element name
	 * 
