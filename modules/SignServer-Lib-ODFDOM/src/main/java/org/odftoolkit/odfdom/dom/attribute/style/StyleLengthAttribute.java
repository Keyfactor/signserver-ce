...
public class StyleLengthAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.STYLE), "length" );
	...
	public void setValue(String attrValue) {
		try{
			//2DO: need validate value against positiveInteger;enum
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of style:length is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute style:length} dependent of its element name
	 * 
