...
public class TableContainsHeaderAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "contains-header" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:contains-header is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:contains-header} dependent of its element name
	 * 
