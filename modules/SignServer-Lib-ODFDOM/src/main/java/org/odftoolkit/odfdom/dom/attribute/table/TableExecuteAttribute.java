...
public class TableExecuteAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "execute" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:execute is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:execute} dependent of its element name
	 * 
