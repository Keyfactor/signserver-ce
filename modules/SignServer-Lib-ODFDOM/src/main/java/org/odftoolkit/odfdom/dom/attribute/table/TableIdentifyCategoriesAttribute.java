...
public class TableIdentifyCategoriesAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "identify-categories" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:identify-categories is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:identify-categories} dependent of its element name
	 * 
