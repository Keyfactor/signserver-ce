...
public class TableIsSelectionAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "is-selection" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:is-selection is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:is-selection} dependent of its element name
	 * 
