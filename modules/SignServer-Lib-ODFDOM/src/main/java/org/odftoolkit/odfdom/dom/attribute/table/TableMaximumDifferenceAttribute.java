...
public class TableMaximumDifferenceAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "maximum-difference" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:maximum-difference is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:maximum-difference} dependent of its element name
	 * 
