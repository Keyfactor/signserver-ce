...
public class TableNumberMatrixColumnsSpannedAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "number-matrix-columns-spanned" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:number-matrix-columns-spanned is not valid");
		}
	}
