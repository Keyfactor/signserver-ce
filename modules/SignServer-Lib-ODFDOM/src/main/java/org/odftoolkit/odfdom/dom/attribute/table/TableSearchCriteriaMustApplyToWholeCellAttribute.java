...
public class TableSearchCriteriaMustApplyToWholeCellAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "search-criteria-must-apply-to-whole-cell" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:search-criteria-must-apply-to-whole-cell is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:search-criteria-must-apply-to-whole-cell} dependent of its element name
	 * 
