...
public class TextCapitalizeEntriesAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "capitalize-entries" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:capitalize-entries is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:capitalize-entries} dependent of its element name
	 * 
