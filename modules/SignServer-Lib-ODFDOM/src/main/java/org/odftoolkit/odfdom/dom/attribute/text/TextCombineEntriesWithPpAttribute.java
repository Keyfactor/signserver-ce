...
public class TextCombineEntriesWithPpAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "combine-entries-with-pp" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:combine-entries-with-pp is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:combine-entries-with-pp} dependent of its element name
	 * 
