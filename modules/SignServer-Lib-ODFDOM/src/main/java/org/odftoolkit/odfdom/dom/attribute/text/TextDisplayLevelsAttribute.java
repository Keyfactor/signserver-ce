...
public class TextDisplayLevelsAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "display-levels" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:display-levels is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:display-levels} dependent of its element name
	 * 
