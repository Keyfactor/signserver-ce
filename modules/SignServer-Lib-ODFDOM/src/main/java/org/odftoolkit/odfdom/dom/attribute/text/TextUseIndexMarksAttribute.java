...
public class TextUseIndexMarksAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "use-index-marks" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:use-index-marks is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:use-index-marks} dependent of its element name
	 * 
