...
public class TextUseIndexSourceStylesAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "use-index-source-styles" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:use-index-source-styles is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:use-index-source-styles} dependent of its element name
	 * 
