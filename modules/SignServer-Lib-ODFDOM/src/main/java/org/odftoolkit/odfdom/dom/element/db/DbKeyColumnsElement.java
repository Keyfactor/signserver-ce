...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "key-columns" );
	 ...
	 *
	 * @return   return  the element {@odf.element db:key-column}
	 * DifferentQName 
	 */
