...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "floating-frame" );
	...
	{
		DrawFrameNameAttribute attr = (DrawFrameNameAttribute) getOdfAttribute( OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "frame-name" ) );
		if( attr != null ){
