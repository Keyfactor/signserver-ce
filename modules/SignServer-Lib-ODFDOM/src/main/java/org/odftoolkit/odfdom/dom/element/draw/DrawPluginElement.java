 ...
 *
 */
public abstract class DrawPluginElement extends OdfElement
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "plugin" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  DrawPluginElement}
	 *
	...
	{
		DrawMimeTypeAttribute attr = (DrawMimeTypeAttribute) getOdfAttribute( OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "mime-type" ) );
		if( attr != null ){
