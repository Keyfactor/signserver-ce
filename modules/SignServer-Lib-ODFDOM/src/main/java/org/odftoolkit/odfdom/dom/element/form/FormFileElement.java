...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "file" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  FormFileElement}
	 *
