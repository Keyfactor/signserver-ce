...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.NUMBER), "number-style" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  NumberNumberStyleElement}
	 *
	 ...
	 *
	 * @return   return  the element {@odf.element number:scientific-number}
	 * DifferentQName 
	 */
	 ...
	 *
	 * @return   return  the element {@odf.element number:fraction}
	 * DifferentQName 
	 */
