 ...
 *
 */
public abstract class TableLastRowElement extends OdfStylableElement
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "last-row" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  TableLastRowElement}
	 *
