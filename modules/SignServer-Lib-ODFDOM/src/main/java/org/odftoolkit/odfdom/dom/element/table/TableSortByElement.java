...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "sort-by" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  TableSortByElement}
	 *
     * @param tableFieldNumberAttributeValue  The mandatory attribute {@odf.attribute  table:field-number}"
     *
	 */
	public void init(int tableFieldNumberAttributeValue)
	{
