 ...
 *
 */
public abstract class TextIndexEntryPageNumberElement extends OdfStylableElement
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "index-entry-page-number" );
