 ...
 *
 */
public abstract class TextLineBreakElement extends OdfElement
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "line-break" );
