 ...
 *
 */
public abstract class TextReferenceMarkElement extends OdfElement
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "reference-mark" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  TextReferenceMarkElement}
	 *
