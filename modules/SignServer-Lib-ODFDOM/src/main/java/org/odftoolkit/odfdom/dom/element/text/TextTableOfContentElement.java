...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "table-of-content" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  TextTableOfContentElement}
	 *
	 ...
	 *
	 * @return   return  the element {@odf.element text:table-of-content-source}
	 * DifferentQName 
	 */
