...
public class CertificateOrderingUnitTest extends ModulesTestCase {
    ...
    public void setUp() throws Exception {
        ...
        cert100 = new JcaX509CertificateConverter().getCertificate(new CertBuilder().setSerialNumber(new BigInteger("100")).setSubject("CN=Cert 100").addExtension(new CertExt(X509Extension.extendedKeyUsage, true, new ExtendedKeyUsage(KeyPurposeId.id_kp_timeStamping))).build());
