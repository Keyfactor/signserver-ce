...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <title>XAdES Signing Demo - SignServer</title>
    </head>
    <body>
        <div id="container1">
            ...
            <h3>XAdES Signing Demo</h3>
            <form id="recievefile" action="../worker/XAdESSigner"
                  method="post" enctype="multipart/form-data">

                <p>Simply upload a XML document to the XAdES signer and you will get
                    back the same XML, but signed by SignServer. This is a central
                    organization signature.</p>

                <table width="100%" border="0" cellspacing="3" cellpadding="3">
                    <tr id="Row1">
                        <td valign="top" align="right">Select XML document to upload and sign</td>
                        <td valign="top">
