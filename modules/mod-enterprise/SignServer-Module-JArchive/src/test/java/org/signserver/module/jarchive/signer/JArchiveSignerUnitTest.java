...
public class JArchiveSignerUnitTest {
    ...
    public static void setUpClass() throws Exception {
        ...
        final Certificate[] certChainRSA2 =
                new Certificate[] {
                    ...
                    new JcaX509CertificateConverter().getCertificate(new CertBuilder()
                        ...
                        .addExtension(new CertExt(X509Extension.subjectKeyIdentifier, false, new JcaX509ExtensionUtils().createSubjectKeyIdentifier(signerKeyPairRSA2.getPublic())))
                        .addExtension(new CertExt(X509Extension.extendedKeyUsage, false, new ExtendedKeyUsage(KeyPurposeId.id_kp_codeSigning).toASN1Primitive()))
                        .build()),
        ...
        /* JDK8: final Certificate[] certChainDSA =
                new Certificate[] {
                    // Code Signer
                    new JcaX509CertificateConverter().getCertificate(new CertBuilder()
                        .setIssuerPrivateKey(caKeyPair.getPrivate())
...
//    }
    ...
    public void testNormalSigning_RSA() throws Exception {
        ...
        signAndAssertSignedAndTimestamped(tokenRSA, new ConfigBuilder()
                .create(), null, JAVA_SHA_256, CMSAlgorithm.SHA256, PKCSObjectIdentifiers.rsaEncryption);
    }
...
//    }
    ...
    public void testNormalSigning_SHA384WithRSA() throws Exception {
        ...
        signAndAssertSignedAndTimestamped(tokenRSA, new ConfigBuilder()
                ...
                .create(), null, JAVA_SHA_256, CMSAlgorithm.SHA384, PKCSObjectIdentifiers.rsaEncryption);
    }
    ...
    public void testNormalSigning_SHA512WithRSA() throws Exception {
        ...
        signAndAssertSignedAndTimestamped(tokenRSA, new ConfigBuilder()
                ...
                .create(), null, JAVA_SHA_256, CMSAlgorithm.SHA512, PKCSObjectIdentifiers.rsaEncryption);
    }
...
//    }
    ...
    public void testNormalSigning_digestSHA1() throws Exception {
        ...
        signAndAssertSignedAndTimestamped(tokenRSA, new ConfigBuilder()
                ...
                .withSignatureAlgorithm("SHA256WithRSA")
                .create(), null, JAVA_SHA1, CMSAlgorithm.SHA256, PKCSObjectIdentifiers.rsaEncryption);
    }
...
//    }
    ...
    public void testIncorrectDocument_garbage() throws Exception {
        ...
        try {
            signData("anything-not-correct-123-".getBytes("ASCII"), tokenRSA, new ConfigBuilder()
                    .create(), null);
            fail("Expected IllegalRequestException");
        } catch (IllegalRequestException expected) { // NOPMD
            // OK
    ...
    public void testIncorrectDocument_garbageMZ() throws Exception {
        ...
        try {
            signData("PK+not-correct-123-".getBytes("ASCII"), tokenRSA, new ConfigBuilder()
                    .create(), null);
            fail("Expected IllegalRequestException");
        } catch (IllegalRequestException expected) { // NOPMD
            // OK
...
//    }
    ...
    public void testSignZIP() throws Exception {
        ...
        try (
            ...
            assertSignedAndTimestamped(requestData, responseData, tokenRSA, JAVA_SHA_256, CMSAlgorithm.SHA256, PKCSObjectIdentifiers.rsaEncryption, resp);
        }
    }
     ...
     */
    @Test
    public void testInit_incorrectZipAlign() throws Exception {
    ...
    public void testSignAgain_CERT0_SHA256() throws Exception {
        ...
        try (
            ...
            assertSignedAndTimestamped(requestData, responseData, tokenRSA, JAVA_SHA_256, CMSAlgorithm.SHA256, PKCSObjectIdentifiers.rsaEncryption, resp, signerCerts, sigEntries);
        }
    }
    ...
    public void testSignAgain_replaceSigs() throws Exception {
        ...
        try (
            ...
            assertSignedAndTimestamped(requestData, responseData, tokenRSA, JAVA_SHA1, CMSAlgorithm.SHA256, PKCSObjectIdentifiers.rsaEncryption, resp, signerCerts, sigEntries);
        }
    }
    ...
    public void testSignAgain_sameAlias() throws Exception {
        ...
        try (
                CloseableReadableData requestData = ModulesTestCase.createRequestDataKeepingFile(executableFileWithSignatureTS);
                CloseableWritableData responseData = ModulesTestCase.createResponseData(true);
            ) {
            ...
            try {
                signData(requestData, responseData, tokenRSA, new ConfigBuilder()
                    ...
                    .withKeepSignatures(true)
                    .create(), null);
                fail("Should have thrown IllegalRequestException as the file already contains a signature with the same name and replaceSigature=false");
            } catch (IllegalRequestException expected) { // NOPMD
                // OK
            }
        }
     ...
     */
    @Test
    public void testInit_incorrectKeepSignatures() throws Exception {
     ...
     */
    @Test
    public void testInit_incorrectReplaceSignature() throws Exception {
        LOG.info("testInit_incorrectKeepSignatures");
        WorkerConfig config = createConfig();
     ...
     */
    @Test
    public void testInit_incorrectSignatureNameType() throws Exception {
     ...
     */
    @Test
    public void testInit_incorrectSignatureNameValue_KEYALIAS() throws Exception {
     ...
     */
    @Test
    public void testInit_missingSignatureNameValue_VALUE() throws Exception {
    ...
    public void testSigning_SignatureNameType_VALUE() throws Exception {
        ...
        try (
                ...
                SignatureResponse res = signData(requestData, responseData, tokenRSA, new ConfigBuilder()
                    ...
                    .create(), null);
            assertSignedAndTimestamped(requestData, responseData, tokenRSA, JAVA_SHA_256, CMSAlgorithm.SHA256, PKCSObjectIdentifiers.rsaEncryption, res);
     ...
     */
    @Test
    public void testInit_incorrectSignatureNameValue_tooLongVALUE() throws Exception {
     ...
     */
    @Test
    public void testInit_incorrectSignatureNameValue_spacesInVALUE() throws Exception {
    ...
    @Test
    public void testConvertToValidSignatureName() throws Exception {
    ...
    public void testSigningWithIntermediateCert_3levels() throws Exception {
        ...
        try (
            ...
            SignatureResponse resp = signData(requestData, responseData, tokenRSAwithIntermediate, new ConfigBuilder()
                    ...
                    .withSignatureNameType(SignatureNameType.VALUE).withSignatureNameValue("CERT")
                    .create(), null);
            assertSignedAndTimestamped(requestData, responseData, tokenRSAwithIntermediate, JAVA_SHA_256, CMSAlgorithm.SHA256, PKCSObjectIdentifiers.rsaEncryption, resp);
     ...
     */
    @Test
    public void testInit_incorrectTSAPolicyOID() throws Exception {
    ...
    private List<? extends Certificate> getCertificateChainFromJAR(byte[] data) throws Exception {
        ...
        try {
            ...
            while (entries.hasMoreElements()) {
                ...
                // Gather the signer certificates from the first entry which has any
                if (entry.getCodeSigners().length > 0) {
    ...
    private void signAndAssertSignedAndTimestamped(MockedCryptoToken token, WorkerConfig config, RequestContext requestContext, String sfDigestAlg, ASN1ObjectIdentifier cmsDigestAlgOID, ASN1ObjectIdentifier sigAlgOID) throws Exception {
        try (
            ...
            assertSignedAndTimestamped(requestData, responseData, token, sfDigestAlg, cmsDigestAlgOID, sigAlgOID, res, Collections.<Certificate>emptyList(), Collections.<WrappedJarEntry>emptyList());
        }
    }
    ...
    private class WrappedJarEntry extends JarEntry {
