...
if "%JAVA_HOME%" == "" (
  java -cp %CLASSPATH% -splash:modules/SignServer-AdminGUI/src/splash.png %class_name% %a% %b% %c% %d% %e% %f% %g% %h% %i% %j% -connectfile modules/SignServer-AdminGUI/connect.properties -defaultconnectfile modules/SignServer-AdminGUI/connect.properties
) else (
  "%JAVA_HOME%\bin\java" -cp %CLASSPATH% -splash:modules/SignServer-AdminGUI/src/splash.png %class_name% %a% %b% %c% %d% %e% %f% %g% %h% %i% %j% -connectfile modules/SignServer-AdminGUI/connect.properties -defaultconnectfile modules/SignServer-AdminGUI/connect.properties
