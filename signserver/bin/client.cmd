...
if "%JAVA_HOME%" == "" (
  java -cp %CLASSPATH%  org.signserver.client.cli.Main %*
) else (
  "%JAVA_HOME%\bin\java" -cp %CLASSPATH% org.signserver.client.cli.Main %*
)
:end
