...
CRYPTOTOKENS_VERSION=3.10.1
mvn ${MVN_OPTS} install:install-file -Dfile="${DIR}/ext/cryptotokens-${CRYPTOTOKENS_VERSION}.pom" -DgroupId=com.keyfactor -DartifactId=cryptotokens -Dversion=${CRYPTOTOKENS_VERSION} -Dpackaging=pom
...
CESECORE_VERSION=7.0.0.1signserver7.4.0.2
# cesecore-common jar
