...
if [ ! -f ${SIGNSRV_HOME}/SignServer-AdminCLI/dist/SignServer-AdminCLI.jar ]
    then
...
# library classpath
CP="$SIGNSRV_HOME/SignServer-AdminCLI/dist/SignServer-AdminCLI.jar"
for i in "${SIGNSRV_HOME}"/SignServer-AdminCLI/lib/*.jar
do
	CP="$i":"$CP"
done
