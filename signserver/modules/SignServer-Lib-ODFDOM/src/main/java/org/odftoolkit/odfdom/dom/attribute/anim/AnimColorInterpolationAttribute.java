...
public class AnimColorInterpolationAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.ANIM), "color-interpolation" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of anim:color-interpolation is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute anim:color-interpolation} dependent of its element name
	 * 
