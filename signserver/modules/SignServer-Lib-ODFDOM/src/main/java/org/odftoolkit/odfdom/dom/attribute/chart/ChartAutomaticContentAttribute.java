...
public class ChartAutomaticContentAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.CHART), "automatic-content" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of chart:automatic-content is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute chart:automatic-content} dependent of its element name
	 * 
