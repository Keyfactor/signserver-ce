...
public class DbAppendTableAliasNameAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "append-table-alias-name" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of db:append-table-alias-name is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute db:append-table-alias-name} dependent of its element name
	 * 
