...
public class DbDeleteRuleAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "delete-rule" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of db:delete-rule is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute db:delete-rule} dependent of its element name
	 * 
