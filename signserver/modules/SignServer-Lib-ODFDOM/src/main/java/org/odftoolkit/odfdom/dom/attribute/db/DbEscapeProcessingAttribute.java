...
public class DbEscapeProcessingAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "escape-processing" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of db:escape-processing is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute db:escape-processing} dependent of its element name
	 * 
