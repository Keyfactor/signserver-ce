...
public class DbFieldAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "field" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of db:field is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute db:field} dependent of its element name
	 * 
