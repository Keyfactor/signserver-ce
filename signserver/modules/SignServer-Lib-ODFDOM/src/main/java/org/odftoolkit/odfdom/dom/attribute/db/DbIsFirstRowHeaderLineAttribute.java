...
public class DbIsFirstRowHeaderLineAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "is-first-row-header-line" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of db:is-first-row-header-line is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute db:is-first-row-header-line} dependent of its element name
	 * 
