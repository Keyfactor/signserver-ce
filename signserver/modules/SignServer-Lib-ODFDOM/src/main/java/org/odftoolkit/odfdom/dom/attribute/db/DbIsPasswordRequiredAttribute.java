...
public class DbIsPasswordRequiredAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "is-password-required" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of db:is-password-required is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute db:is-password-required} dependent of its element name
	 * 
