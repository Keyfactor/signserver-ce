...
public class DbIsTableNameLengthLimitedAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "is-table-name-length-limited" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of db:is-table-name-length-limited is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute db:is-table-name-length-limited} dependent of its element name
	 * 
