...
public class DbParameterNameSubstitutionAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "parameter-name-substitution" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of db:parameter-name-substitution is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute db:parameter-name-substitution} dependent of its element name
	 * 
