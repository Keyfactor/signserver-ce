...
public class DbShowDeletedAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "show-deleted" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of db:show-deleted is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute db:show-deleted} dependent of its element name
	 * 
