...
public class DbStringAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "string" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of db:string is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute db:string} dependent of its element name
	 * 
