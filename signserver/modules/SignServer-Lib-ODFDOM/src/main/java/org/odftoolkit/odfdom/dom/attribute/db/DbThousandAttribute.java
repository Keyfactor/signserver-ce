...
public class DbThousandAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "thousand" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of db:thousand is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute db:thousand} dependent of its element name
	 * 
