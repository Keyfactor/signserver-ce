...
public class DbUseCatalogAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "use-catalog" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of db:use-catalog is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute db:use-catalog} dependent of its element name
	 * 
