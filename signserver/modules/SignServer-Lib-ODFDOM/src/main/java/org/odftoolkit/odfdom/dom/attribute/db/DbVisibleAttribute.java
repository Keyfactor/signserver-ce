...
public class DbVisibleAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "visible" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of db:visible is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute db:visible} dependent of its element name
	 * 
