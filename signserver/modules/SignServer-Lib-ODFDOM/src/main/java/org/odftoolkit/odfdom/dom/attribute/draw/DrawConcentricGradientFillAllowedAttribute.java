...
public class DrawConcentricGradientFillAllowedAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "concentric-gradient-fill-allowed" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of draw:concentric-gradient-fill-allowed is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute draw:concentric-gradient-fill-allowed} dependent of its element name
	 * 
