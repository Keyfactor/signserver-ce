...
public class DrawExtrusionBrightnessAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "extrusion-brightness" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of draw:extrusion-brightness is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute draw:extrusion-brightness} dependent of its element name
	 * 
