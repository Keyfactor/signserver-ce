...
public class DrawExtrusionColorAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "extrusion-color" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of draw:extrusion-color is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute draw:extrusion-color} dependent of its element name
	 * 
