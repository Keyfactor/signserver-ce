...
public class DrawExtrusionDiffusionAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "extrusion-diffusion" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of draw:extrusion-diffusion is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute draw:extrusion-diffusion} dependent of its element name
	 * 
