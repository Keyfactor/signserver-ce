...
public class DrawExtrusionOriginAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "extrusion-origin" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of draw:extrusion-origin is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute draw:extrusion-origin} dependent of its element name
	 * 
