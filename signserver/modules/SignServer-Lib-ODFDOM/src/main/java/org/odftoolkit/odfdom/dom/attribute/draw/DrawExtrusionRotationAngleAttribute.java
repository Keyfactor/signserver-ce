...
public class DrawExtrusionRotationAngleAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "extrusion-rotation-angle" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of draw:extrusion-rotation-angle is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute draw:extrusion-rotation-angle} dependent of its element name
	 * 
