...
public class DrawExtrusionSecondLightLevelAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "extrusion-second-light-level" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of draw:extrusion-second-light-level is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute draw:extrusion-second-light-level} dependent of its element name
	 * 
