...
public class DrawHandleMirrorHorizontalAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "handle-mirror-horizontal" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of draw:handle-mirror-horizontal is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute draw:handle-mirror-horizontal} dependent of its element name
	 * 
