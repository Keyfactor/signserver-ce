...
public class DrawHandleMirrorVerticalAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "handle-mirror-vertical" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of draw:handle-mirror-vertical is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute draw:handle-mirror-vertical} dependent of its element name
	 * 
