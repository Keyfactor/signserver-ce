...
public class DrawHandleSwitchedAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "handle-switched" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of draw:handle-switched is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute draw:handle-switched} dependent of its element name
	 * 
