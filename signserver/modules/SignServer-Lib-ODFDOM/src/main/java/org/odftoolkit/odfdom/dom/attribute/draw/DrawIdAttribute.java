...
public class DrawIdAttribute extends OdfAttribute {
	...
	public void setValue(String attrValue) {
		...
		if( parentElement != null ){
			try {
				if( parentElement instanceof Dr3dCubeElement ){
					//2DO: need validate value against NCName
					super.setValue(attrValue);
				}else if( parentElement instanceof Dr3dExtrudeElement ){
					//2DO: need validate value against NCName
					super.setValue(attrValue);
				}else if( parentElement instanceof Dr3dRotateElement ){
					//2DO: need validate value against NCName
					super.setValue(attrValue);
				}else if( parentElement instanceof Dr3dSceneElement ){
					//2DO: need validate value against NCName
					super.setValue(attrValue);
				}else if( parentElement instanceof Dr3dSphereElement ){
					//2DO: need validate value against NCName
					super.setValue(attrValue);
