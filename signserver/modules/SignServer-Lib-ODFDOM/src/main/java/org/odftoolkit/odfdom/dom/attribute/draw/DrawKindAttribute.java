...
public class DrawKindAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "kind" );
	...
	/**
	 * Returns the default value of {@odf.attribute draw:kind} dependent of its element name
	 * 
