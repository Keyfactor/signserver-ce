...
public class DrawMayScriptAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "may-script" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of draw:may-script is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute draw:may-script} dependent of its element name
	 * 
