...
public class DrawMirrorHorizontalAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "mirror-horizontal" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of draw:mirror-horizontal is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute draw:mirror-horizontal} dependent of its element name
	 * 
