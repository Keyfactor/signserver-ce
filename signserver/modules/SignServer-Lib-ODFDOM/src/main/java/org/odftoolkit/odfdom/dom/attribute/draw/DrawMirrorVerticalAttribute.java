...
public class DrawMirrorVerticalAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "mirror-vertical" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of draw:mirror-vertical is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute draw:mirror-vertical} dependent of its element name
	 * 
