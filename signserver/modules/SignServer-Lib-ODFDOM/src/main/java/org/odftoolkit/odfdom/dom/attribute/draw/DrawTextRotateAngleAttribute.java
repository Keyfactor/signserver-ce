...
public class DrawTextRotateAngleAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "text-rotate-angle" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of draw:text-rotate-angle is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute draw:text-rotate-angle} dependent of its element name
	 * 
