		...
		if( parentElement != null ){
			try {
				if( parentElement instanceof DrawConnectorElement ){
					super.setValue(DrawConnectorElement.DrawTypeAttributeValue.enumValueOf(attrValue).toString());
	...
	public String getValue(){
		...
		if( parentElement != null ){
			try {
				...
				// TODO: validation handling/logging
				throw new NumberFormatException("the value of draw:type is not valid");
			}
		}else{
			//2DO:what should do when the owner element is null?
			return super.getValue();
