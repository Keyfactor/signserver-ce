...
public class FoEndIndentAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FO), "end-indent" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of fo:end-indent is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute fo:end-indent} dependent of its element name
	 * 
