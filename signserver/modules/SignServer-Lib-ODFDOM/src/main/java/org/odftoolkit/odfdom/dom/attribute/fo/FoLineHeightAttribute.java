...
public class FoLineHeightAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FO), "line-height" );
	...
	public void setValue(String attrValue) {
		try{
			//2DO: need validate value against nonNegativeLength;percent;enum
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of fo:line-height is not valid");
		}
	}
