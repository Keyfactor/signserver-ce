		...
		if( parentElement != null ){
			try {
				if( parentElement instanceof StyleGraphicPropertiesElement ){
					...
					//2DO: need validate value against length;percent
					super.setValue(attrValue);
				}else if( parentElement instanceof StyleListLevelLabelAlignmentElement ){
					//2DO: need validate value against Length
					super.setValue(attrValue);
				}else if( parentElement instanceof StylePageLayoutPropertiesElement ){
					//2DO: need validate value against length;percent
					super.setValue(attrValue);
	...
	public String getValue(){
		...
		if( parentElement != null ){
			try {
				...
				// TODO: validation handling/logging
				throw new NumberFormatException("the value of fo:margin-left is not valid");
			}
		}else{
			//2DO:what should do when the owner element is null?
			return super.getValue();
