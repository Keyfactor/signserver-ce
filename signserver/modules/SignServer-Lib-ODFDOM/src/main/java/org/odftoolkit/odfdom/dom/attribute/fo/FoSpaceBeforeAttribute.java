...
public class FoSpaceBeforeAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FO), "space-before" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of fo:space-before is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute fo:space-before} dependent of its element name
	 * 
