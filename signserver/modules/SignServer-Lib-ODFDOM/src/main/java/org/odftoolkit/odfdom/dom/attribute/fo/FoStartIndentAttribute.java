...
public class FoStartIndentAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FO), "start-indent" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of fo:start-indent is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute fo:start-indent} dependent of its element name
	 * 
