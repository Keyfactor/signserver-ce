...
public class FormAutomaticFocusAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "automatic-focus" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of form:automatic-focus is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute form:automatic-focus} dependent of its element name
	 * 
