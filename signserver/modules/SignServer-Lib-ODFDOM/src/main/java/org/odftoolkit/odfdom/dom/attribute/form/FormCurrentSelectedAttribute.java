...
public class FormCurrentSelectedAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "current-selected" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of form:current-selected is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute form:current-selected} dependent of its element name
	 * 
