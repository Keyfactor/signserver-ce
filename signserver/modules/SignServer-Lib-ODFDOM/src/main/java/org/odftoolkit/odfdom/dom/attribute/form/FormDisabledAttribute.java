...
public class FormDisabledAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "disabled" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of form:disabled is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute form:disabled} dependent of its element name
	 * 
