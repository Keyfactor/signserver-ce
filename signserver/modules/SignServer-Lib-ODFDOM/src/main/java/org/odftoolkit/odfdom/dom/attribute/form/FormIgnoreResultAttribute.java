...
public class FormIgnoreResultAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "ignore-result" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of form:ignore-result is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute form:ignore-result} dependent of its element name
	 * 
