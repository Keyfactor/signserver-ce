...
public class FormImagePositionAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "image-position" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of form:image-position is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute form:image-position} dependent of its element name
	 * 
