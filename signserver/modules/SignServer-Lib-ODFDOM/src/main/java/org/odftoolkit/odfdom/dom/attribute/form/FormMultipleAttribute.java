...
public class FormMultipleAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "multiple" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of form:multiple is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute form:multiple} dependent of its element name
	 * 
