...
public class FormSelectedAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "selected" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of form:selected is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute form:selected} dependent of its element name
	 * 
