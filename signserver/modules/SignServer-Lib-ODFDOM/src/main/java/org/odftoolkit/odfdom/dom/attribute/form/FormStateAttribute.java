...
public class FormStateAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "state" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of form:state is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute form:state} dependent of its element name
	 * 
