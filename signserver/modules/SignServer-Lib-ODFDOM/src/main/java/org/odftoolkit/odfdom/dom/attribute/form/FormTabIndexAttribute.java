...
public class FormTabIndexAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "tab-index" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of form:tab-index is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute form:tab-index} dependent of its element name
	 * 
