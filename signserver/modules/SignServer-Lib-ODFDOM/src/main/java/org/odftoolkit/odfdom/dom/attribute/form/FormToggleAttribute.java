...
public class FormToggleAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "toggle" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of form:toggle is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute form:toggle} dependent of its element name
	 * 
