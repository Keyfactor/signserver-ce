...
public class NumberFormatSourceAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.NUMBER), "format-source" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of number:format-source is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute number:format-source} dependent of its element name
	 * 
