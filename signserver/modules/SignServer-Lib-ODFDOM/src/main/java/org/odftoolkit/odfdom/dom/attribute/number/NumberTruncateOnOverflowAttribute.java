...
public class NumberTruncateOnOverflowAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.NUMBER), "truncate-on-overflow" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of number:truncate-on-overflow is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute number:truncate-on-overflow} dependent of its element name
	 * 
