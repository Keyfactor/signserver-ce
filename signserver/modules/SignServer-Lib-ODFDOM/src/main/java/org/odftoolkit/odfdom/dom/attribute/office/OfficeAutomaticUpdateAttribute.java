...
public class OfficeAutomaticUpdateAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.OFFICE), "automatic-update" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of office:automatic-update is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute office:automatic-update} dependent of its element name
	 * 
