...
public class OfficeServerMapAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.OFFICE), "server-map" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of office:server-map is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute office:server-map} dependent of its element name
	 * 
