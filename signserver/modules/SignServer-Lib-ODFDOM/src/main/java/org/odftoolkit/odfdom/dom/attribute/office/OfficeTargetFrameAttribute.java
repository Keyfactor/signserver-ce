...
public class OfficeTargetFrameAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.OFFICE), "target-frame" );
	...
	public void setValue(String attrValue) {
		try{
			//2DO: need validate value against TargetFrameName
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of office:target-frame is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute office:target-frame} dependent of its element name
	 * 
