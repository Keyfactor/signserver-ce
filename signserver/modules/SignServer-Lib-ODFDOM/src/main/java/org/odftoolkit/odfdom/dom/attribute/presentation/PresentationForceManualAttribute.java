...
public class PresentationForceManualAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.PRESENTATION), "force-manual" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of presentation:force-manual is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute presentation:force-manual} dependent of its element name
	 * 
