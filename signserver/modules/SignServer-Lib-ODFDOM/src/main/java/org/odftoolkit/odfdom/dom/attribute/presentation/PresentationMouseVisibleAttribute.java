...
public class PresentationMouseVisibleAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.PRESENTATION), "mouse-visible" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of presentation:mouse-visible is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute presentation:mouse-visible} dependent of its element name
	 * 
