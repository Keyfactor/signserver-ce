...
public class PresentationStartScaleAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.PRESENTATION), "start-scale" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of presentation:start-scale is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute presentation:start-scale} dependent of its element name
	 * 
