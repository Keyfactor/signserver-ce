...
public class PresentationStayOnTopAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.PRESENTATION), "stay-on-top" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of presentation:stay-on-top is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute presentation:stay-on-top} dependent of its element name
	 * 
