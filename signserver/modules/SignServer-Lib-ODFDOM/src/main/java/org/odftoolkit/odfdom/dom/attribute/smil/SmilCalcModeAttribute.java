...
public class SmilCalcModeAttribute extends OdfAttribute {
	...
	/**
	 * Returns the default value of {@odf.attribute smil:calcMode} dependent of its element name
	 * 
	...
	public String getDefault() {
		...
		if (parentElement != null) {
			...
			}else if( parentElement instanceof AnimAnimateColorElement ){
				defaultValue = DEFAULT_VALUE_DISCRETE;
			}else if( parentElement instanceof AnimAnimateMotionElement ){
