...
public class StyleColorAttribute extends OdfAttribute {
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of style:color is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute style:color} dependent of its element name
	 * 
