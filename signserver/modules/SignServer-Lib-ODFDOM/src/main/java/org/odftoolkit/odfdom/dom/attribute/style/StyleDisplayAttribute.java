...
public class StyleDisplayAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.STYLE), "display" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of style:display is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute style:display} dependent of its element name
	 * 
