...
public class StyleFontSizeComplexAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.STYLE), "font-size-complex" );
	...
	public void setValue(String attrValue) {
		try{
			//2DO: need validate value against positiveLength;percent
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of style:font-size-complex is not valid");
		}
	}
