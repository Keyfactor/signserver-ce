...
public class StyleLeaderTextAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.STYLE), "leader-text" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of style:leader-text is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute style:leader-text} dependent of its element name
	 * 
