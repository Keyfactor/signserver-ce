...
public class StyleScriptComplexAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.STYLE), "script-complex" );
	...
	public void setValue(String attrValue) {
		try{
			//2DO: need validate value against ScriptCode
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of style:script-complex is not valid");
		}
	}
