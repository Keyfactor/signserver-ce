...
public class SvgCyAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.SVG), "cy" );
	...
	public void setValue(String attrValue) {
		...
		if( parentElement != null ){
			try {
				if( parentElement instanceof DrawAreaCircleElement ){
	...
	public String getValue(){
		...
		if( parentElement != null ){
			try {
				...
				// TODO: validation handling/logging
				throw new NumberFormatException("the value of svg:cy is not valid");
			}
		}else{
			//2DO:what should do when the owner element is null?
			return super.getValue();
	...
	/**
	 * Returns the default value of {@odf.attribute svg:cy} dependent of its element name
	 * 
