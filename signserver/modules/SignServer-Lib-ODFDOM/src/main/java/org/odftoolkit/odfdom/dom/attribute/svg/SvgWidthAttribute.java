...
public class SvgWidthAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.SVG), "width" );
	...
	public void setValue(String attrValue) {
		...
		if( parentElement != null ){
			try {
				...
				}else if( parentElement instanceof ChartFloorElement ){
					//2DO: need validate value against Length
					super.setValue(attrValue);
				}else if( parentElement instanceof ChartPlotAreaElement ){
					//2DO: need validate value against Length
					super.setValue(attrValue);
				}else if( parentElement instanceof ChartWallElement ){
					//2DO: need validate value against Length
					super.setValue(attrValue);
	...
	public String getValue(){
		...
		if( parentElement != null ){
			try {
				...
				// TODO: validation handling/logging
				throw new NumberFormatException("the value of svg:width is not valid");
			}
		}else{
			//2DO:what should do when the owner element is null?
			return super.getValue();
