...
public class TableAutomaticFindLabelsAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "automatic-find-labels" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:automatic-find-labels is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:automatic-find-labels} dependent of its element name
	 * 
