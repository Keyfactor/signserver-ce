...
public class TableBindStylesToContentAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "bind-styles-to-content" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:bind-styles-to-content is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:bind-styles-to-content} dependent of its element name
	 * 
