...
public class TableCaseSensitiveAttribute extends OdfAttribute {
	...
	public String getValue(){
		...
		if( parentElement != null ){
			try {
				...
				// TODO: validation handling/logging
				throw new NumberFormatException("the value of table:case-sensitive is not valid");
			}
		}else{
			//2DO:what should do when the owner element is null?
			return super.getValue();
	...
	/**
	 * Returns the default value of {@odf.attribute table:case-sensitive} dependent of its element name
	 * 
