...
public class TableCellRangeAddressAttribute extends OdfAttribute {
	...
	public void setValue(String attrValue) {
		...
		if( parentElement != null ){
			try {
				if( parentElement instanceof ChartCategoriesElement ){
					//2DO: need validate value against CellRangeAddressList
					super.setValue(attrValue);
				}else if( parentElement instanceof ChartDomainElement ){
					//2DO: need validate value against CellRangeAddressList
					super.setValue(attrValue);
				}else if( parentElement instanceof ChartPlotAreaElement ){
					//2DO: need validate value against CellRangeAddressList
					super.setValue(attrValue);
				}else if( parentElement instanceof TableHighlightedRangeElement ){
					//2DO: need validate value against CellRangeAddress
					super.setValue(attrValue);
				}else if( parentElement instanceof TableNamedRangeElement ){
					//2DO: need validate value against CellRangeAddress
					super.setValue(attrValue);
				}else if( parentElement instanceof TableSourceCellRangeElement ){
					//2DO: need validate value against CellRangeAddress
					super.setValue(attrValue);
				}			
