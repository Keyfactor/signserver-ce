...
public class TableContainsErrorAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "contains-error" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:contains-error is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:contains-error} dependent of its element name
	 * 
