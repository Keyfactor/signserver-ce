...
public class TableCopyFormulasAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "copy-formulas" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:copy-formulas is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:copy-formulas} dependent of its element name
	 * 
