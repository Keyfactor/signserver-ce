...
public class TableCopyStylesAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "copy-styles" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:copy-styles is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:copy-styles} dependent of its element name
	 * 
