...
public class TableDateValueAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "date-value" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:date-value is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:date-value} dependent of its element name
	 * 
