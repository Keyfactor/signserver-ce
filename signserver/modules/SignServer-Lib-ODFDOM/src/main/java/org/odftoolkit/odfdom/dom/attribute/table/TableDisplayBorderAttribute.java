...
public class TableDisplayBorderAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "display-border" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:display-border is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:display-border} dependent of its element name
	 * 
