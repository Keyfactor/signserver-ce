...
public class TableDisplayFilterButtonsAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "display-filter-buttons" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:display-filter-buttons is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:display-filter-buttons} dependent of its element name
	 * 
