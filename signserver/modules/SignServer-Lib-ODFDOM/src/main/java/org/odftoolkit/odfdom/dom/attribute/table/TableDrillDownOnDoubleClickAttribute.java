...
public class TableDrillDownOnDoubleClickAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "drill-down-on-double-click" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:drill-down-on-double-click is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:drill-down-on-double-click} dependent of its element name
	 * 
