...
public class TableGrandTotalAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "grand-total" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:grand-total is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:grand-total} dependent of its element name
	 * 
