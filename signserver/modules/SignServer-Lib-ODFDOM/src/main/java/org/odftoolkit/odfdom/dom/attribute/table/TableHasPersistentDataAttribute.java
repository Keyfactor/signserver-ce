...
public class TableHasPersistentDataAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "has-persistent-data" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:has-persistent-data is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:has-persistent-data} dependent of its element name
	 * 
