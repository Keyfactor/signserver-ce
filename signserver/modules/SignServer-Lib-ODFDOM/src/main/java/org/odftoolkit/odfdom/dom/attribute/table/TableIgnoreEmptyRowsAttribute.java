...
public class TableIgnoreEmptyRowsAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "ignore-empty-rows" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:ignore-empty-rows is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:ignore-empty-rows} dependent of its element name
	 * 
