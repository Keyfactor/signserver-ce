...
public class TableIsSubTableAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "is-sub-table" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:is-sub-table is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:is-sub-table} dependent of its element name
	 * 
