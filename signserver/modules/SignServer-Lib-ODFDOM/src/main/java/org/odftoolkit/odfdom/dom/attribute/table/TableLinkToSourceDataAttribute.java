...
public class TableLinkToSourceDataAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "link-to-source-data" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:link-to-source-data is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:link-to-source-data} dependent of its element name
	 * 
