...
public class TableMatrixCoveredAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "matrix-covered" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:matrix-covered is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:matrix-covered} dependent of its element name
	 * 
