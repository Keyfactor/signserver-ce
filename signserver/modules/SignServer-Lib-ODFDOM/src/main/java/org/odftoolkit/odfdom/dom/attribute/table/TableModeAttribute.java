...
public class TableModeAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "mode" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:mode is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:mode} dependent of its element name
	 * 
