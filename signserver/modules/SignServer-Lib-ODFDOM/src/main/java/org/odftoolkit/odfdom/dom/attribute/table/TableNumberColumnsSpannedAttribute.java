...
public class TableNumberColumnsSpannedAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "number-columns-spanned" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:number-columns-spanned is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:number-columns-spanned} dependent of its element name
	 * 
