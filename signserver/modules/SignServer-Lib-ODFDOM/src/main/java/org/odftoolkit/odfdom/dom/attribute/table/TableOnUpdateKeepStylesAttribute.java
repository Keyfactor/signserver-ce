...
public class TableOnUpdateKeepStylesAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "on-update-keep-styles" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:on-update-keep-styles is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:on-update-keep-styles} dependent of its element name
	 * 
