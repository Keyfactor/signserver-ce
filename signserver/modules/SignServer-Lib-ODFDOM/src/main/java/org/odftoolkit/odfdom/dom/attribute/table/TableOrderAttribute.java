...
public class TableOrderAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "order" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:order is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:order} dependent of its element name
	 * 
