...
public class TablePageBreaksOnGroupChangeAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "page-breaks-on-group-change" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:page-breaks-on-group-change is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:page-breaks-on-group-change} dependent of its element name
	 * 
