...
public class TableParseSqlStatementAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "parse-sql-statement" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:parse-sql-statement is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:parse-sql-statement} dependent of its element name
	 * 
