...
public class TablePrecisionAsShownAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "precision-as-shown" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:precision-as-shown is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:precision-as-shown} dependent of its element name
	 * 
