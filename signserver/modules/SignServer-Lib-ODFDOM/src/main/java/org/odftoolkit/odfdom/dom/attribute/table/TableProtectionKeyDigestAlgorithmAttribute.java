...
public class TableProtectionKeyDigestAlgorithmAttribute extends OdfAttribute {
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:protection-key-digest-algorithm is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:protection-key-digest-algorithm} dependent of its element name
	 * 
