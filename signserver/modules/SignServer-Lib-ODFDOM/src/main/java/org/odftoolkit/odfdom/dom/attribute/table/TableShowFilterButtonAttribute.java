...
public class TableShowFilterButtonAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "show-filter-button" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:show-filter-button is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:show-filter-button} dependent of its element name
	 * 
