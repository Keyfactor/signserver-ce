...
public class TableStatusAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "status" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:status is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:status} dependent of its element name
	 * 
