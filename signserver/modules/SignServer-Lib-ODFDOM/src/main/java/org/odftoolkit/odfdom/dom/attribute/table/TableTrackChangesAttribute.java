...
public class TableTrackChangesAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "track-changes" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:track-changes is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:track-changes} dependent of its element name
	 * 
