...
public class TableUseBandingColumnsStylesAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "use-banding-columns-styles" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:use-banding-columns-styles is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:use-banding-columns-styles} dependent of its element name
	 * 
