...
public class TableUseBandingRowsStylesAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "use-banding-rows-styles" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:use-banding-rows-styles is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:use-banding-rows-styles} dependent of its element name
	 * 
