...
public class TableUseLastColumnStylesAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "use-last-column-styles" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:use-last-column-styles is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:use-last-column-styles} dependent of its element name
	 * 
