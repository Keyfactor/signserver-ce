...
public class TableUseLastRowStylesAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "use-last-row-styles" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:use-last-row-styles is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:use-last-row-styles} dependent of its element name
	 * 
