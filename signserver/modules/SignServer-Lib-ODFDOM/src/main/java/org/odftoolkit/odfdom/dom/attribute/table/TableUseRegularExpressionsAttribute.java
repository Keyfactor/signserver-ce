...
public class TableUseRegularExpressionsAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "use-regular-expressions" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:use-regular-expressions is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:use-regular-expressions} dependent of its element name
	 * 
