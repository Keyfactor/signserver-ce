...
public class TableUseWildcardsAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "use-wildcards" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:use-wildcards is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:use-wildcards} dependent of its element name
	 * 
