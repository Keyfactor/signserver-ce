...
public class TableUsedHierarchyAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "used-hierarchy" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:used-hierarchy is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:used-hierarchy} dependent of its element name
	 * 
