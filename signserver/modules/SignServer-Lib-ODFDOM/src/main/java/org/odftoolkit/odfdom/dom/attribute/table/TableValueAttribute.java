		...
		if( parentElement != null ){
			try {
				if( parentElement instanceof TableFilterConditionElement ){
					//2DO: need validate value against string;double
					super.setValue(attrValue);
				}else if( parentElement instanceof TableFilterSetItemElement ){
					super.setValue(attrValue);
				}			
	...
	public String getValue(){
		...
		if( parentElement != null ){
			try {
				...
				// TODO: validation handling/logging
				throw new NumberFormatException("the value of table:value is not valid");
			}
		}else{
			//2DO:what should do when the owner element is null?
			return super.getValue();
