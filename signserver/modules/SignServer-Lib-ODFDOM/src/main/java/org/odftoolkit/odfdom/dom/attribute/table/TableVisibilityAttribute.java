...
public class TableVisibilityAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "visibility" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:visibility is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:visibility} dependent of its element name
	 * 
