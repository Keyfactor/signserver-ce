...
public class TextAlphabeticalSeparatorsAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "alphabetical-separators" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:alphabetical-separators is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:alphabetical-separators} dependent of its element name
	 * 
