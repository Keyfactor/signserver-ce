...
public class TextCombineEntriesAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "combine-entries" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:combine-entries is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:combine-entries} dependent of its element name
	 * 
