...
public class TextCommaSeparatedAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "comma-separated" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:comma-separated is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:comma-separated} dependent of its element name
	 * 
