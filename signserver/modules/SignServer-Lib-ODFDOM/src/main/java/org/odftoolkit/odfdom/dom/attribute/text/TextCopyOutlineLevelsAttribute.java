...
public class TextCopyOutlineLevelsAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "copy-outline-levels" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:copy-outline-levels is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:copy-outline-levels} dependent of its element name
	 * 
