...
public class TextCountEmptyLinesAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "count-empty-lines" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:count-empty-lines is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:count-empty-lines} dependent of its element name
	 * 
