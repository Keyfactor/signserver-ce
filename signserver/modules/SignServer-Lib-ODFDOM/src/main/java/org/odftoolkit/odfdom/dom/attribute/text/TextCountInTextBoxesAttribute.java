...
public class TextCountInTextBoxesAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "count-in-text-boxes" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:count-in-text-boxes is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:count-in-text-boxes} dependent of its element name
	 * 
