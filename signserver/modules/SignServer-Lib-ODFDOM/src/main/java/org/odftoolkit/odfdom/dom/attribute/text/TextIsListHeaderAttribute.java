...
public class TextIsListHeaderAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "is-list-header" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:is-list-header is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:is-list-header} dependent of its element name
	 * 
