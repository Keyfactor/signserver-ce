...
public class TextLevelAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "level" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:level is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:level} dependent of its element name
	 * 
