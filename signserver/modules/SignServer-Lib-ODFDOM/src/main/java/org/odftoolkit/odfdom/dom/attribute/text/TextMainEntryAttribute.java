...
public class TextMainEntryAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "main-entry" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:main-entry is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:main-entry} dependent of its element name
	 * 
