...
public class TextProtectionKeyDigestAlgorithmAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "protection-key-digest-algorithm" );
	...
	public void setValue(String attrValue) {
		try{
			//2DO: need validate value against AnyURI
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:protection-key-digest-algorithm is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:protection-key-digest-algorithm} dependent of its element name
	 * 
