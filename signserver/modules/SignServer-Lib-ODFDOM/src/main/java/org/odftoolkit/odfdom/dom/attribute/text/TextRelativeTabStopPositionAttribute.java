...
public class TextRelativeTabStopPositionAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "relative-tab-stop-position" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:relative-tab-stop-position is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:relative-tab-stop-position} dependent of its element name
	 * 
