...
public class TextTimeValueAttribute extends OdfAttribute {
	...
	public void setValue(String attrValue) {
		...
		if( parentElement != null ){
			try {
				if( parentElement instanceof TextCreationTimeElement ){
					//2DO: need validate value against TimeOrDateTime
					super.setValue(attrValue);
				}else if( parentElement instanceof TextModificationTimeElement ){
					//2DO: need validate value against Time
					super.setValue(attrValue);
				}else if( parentElement instanceof TextPrintTimeElement ){
					//2DO: need validate value against Time
					super.setValue(attrValue);
				}else if( parentElement instanceof TextTimeElement ){
					//2DO: need validate value against TimeOrDateTime
					super.setValue(attrValue);
				}			
	...
	public String getValue(){
		...
		if( parentElement != null ){
			try {
				...
				// TODO: validation handling/logging
				throw new NumberFormatException("the value of text:time-value is not valid");
			}
		}else{
			//2DO:what should do when the owner element is null?
			return super.getValue();
