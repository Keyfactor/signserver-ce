...
public class TextUseDrawObjectsAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "use-draw-objects" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:use-draw-objects is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:use-draw-objects} dependent of its element name
	 * 
