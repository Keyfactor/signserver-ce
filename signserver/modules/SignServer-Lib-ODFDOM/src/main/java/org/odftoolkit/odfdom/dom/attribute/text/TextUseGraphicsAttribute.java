...
public class TextUseGraphicsAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "use-graphics" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:use-graphics is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:use-graphics} dependent of its element name
	 * 
