...
public class TextUseOutlineLevelAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "use-outline-level" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:use-outline-level is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:use-outline-level} dependent of its element name
	 * 
