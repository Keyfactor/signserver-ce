...
public class TextUseSoftPageBreaksAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "use-soft-page-breaks" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:use-soft-page-breaks is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:use-soft-page-breaks} dependent of its element name
	 * 
