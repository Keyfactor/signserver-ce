...
public class TextUseSpreadsheetObjectsAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "use-spreadsheet-objects" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:use-spreadsheet-objects is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:use-spreadsheet-objects} dependent of its element name
	 * 
