...
public class XhtmlDatatypeAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.XHTML), "datatype" );
	...
	public void setValue(String attrValue) {
		try{
			//2DO: need validate value against CURIE
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of xhtml:datatype is not valid");
		}
	}
