...
public class XhtmlPropertyAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.XHTML), "property" );
	...
	public void setValue(String attrValue) {
		try{
			//2DO: need validate value against CURIEs
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of xhtml:property is not valid");
		}
	}
