...
public class XmlIdAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.XML), "id" );
	...
	public void setValue(String attrValue) {
		try{
			//2DO: need validate value against ID
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of xml:id is not valid");
		}
	}
