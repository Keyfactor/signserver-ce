...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.ANIM), "animate" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  AnimAnimateElement}
	 *
