...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.ANIM), "animateTransform" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  AnimAnimateTransformElement}
	 *
     * @param smilAttributeNameAttributeValue  The mandatory attribute {@odf.attribute  smil:attributeName}"
     * @param svgTypeAttributeValue  The mandatory attribute {@odf.attribute  svg:type}"
     *
	 */
	public void init(String smilAttributeNameAttributeValue, String svgTypeAttributeValue)
	{
		setSmilAttributeNameAttribute( smilAttributeNameAttributeValue );
		setSvgTypeAttribute( svgTypeAttributeValue );
	}
	...
	{
		SvgTypeAttribute attr = (SvgTypeAttribute) getOdfAttribute( OdfName.get( OdfNamespace.get(OdfNamespaceNames.SVG), "type" ) );
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
