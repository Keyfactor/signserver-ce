...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.ANIM), "transitionFilter" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  AnimTransitionFilterElement}
	 *
     * @param smilTypeAttributeValue  The mandatory attribute {@odf.attribute  smil:type}"
     *
	 */
	public void init(String smilTypeAttributeValue)
	{
		setSmilTypeAttribute( smilTypeAttributeValue );
	}
	...
	{
		SmilModeAttribute attr = (SmilModeAttribute) getOdfAttribute( OdfName.get( OdfNamespace.get(OdfNamespaceNames.SMIL), "mode" ) );
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
