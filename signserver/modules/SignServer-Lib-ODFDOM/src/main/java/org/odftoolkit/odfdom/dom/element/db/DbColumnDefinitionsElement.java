...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "column-definitions" );
	 ...
	 * @return   return  the element {@odf.element db:column-definition}
	 * DifferentQName 
	 */
    
	public DbColumnDefinitionElement newDbColumnDefinitionElement(String dbNameAttributeValue)
	{
		DbColumnDefinitionElement  dbColumnDefinition = ((OdfFileDom)this.ownerDocument).newOdfElement(DbColumnDefinitionElement.class);
		dbColumnDefinition.setDbNameAttribute( dbNameAttributeValue );
