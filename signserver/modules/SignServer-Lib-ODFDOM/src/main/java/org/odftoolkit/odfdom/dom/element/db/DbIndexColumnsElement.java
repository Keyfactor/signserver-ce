 ...
 *
 */
public abstract class DbIndexColumnsElement extends OdfElement
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "index-columns" );
	 ...
	 * @return   return  the element {@odf.element db:index-column}
	 * DifferentQName 
	 */
    
	public DbIndexColumnElement newDbIndexColumnElement(String dbNameAttributeValue)
	{
		DbIndexColumnElement  dbIndexColumn = ((OdfFileDom)this.ownerDocument).newOdfElement(DbIndexColumnElement.class);
		dbIndexColumn.setDbNameAttribute( dbNameAttributeValue );
