...
/**
 * DOM implementation of OpenDocument element  {@odf.element db:java-classpath}.
 *
 */
public abstract class DbJavaClasspathElement extends OdfElement
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "java-classpath" );
	...
	public static final String  DEFAULT_VALUE_XLINK_SHOW_ATTRIBUTE = XlinkShowAttribute.Value.NONE.toString();
	public static final String  DEFAULT_VALUE_XLINK_ACTUATE_ATTRIBUTE = XlinkActuateAttribute.Value.ONREQUEST.toString();

	/**
	 * Create the instance of <code>DbJavaClasspathElement</code> 
	 *
	 * @param  ownerDoc     The type is <code>OdfFileDom</code>
	 */
	public DbJavaClasspathElement( OdfFileDom ownerDoc )
	{
	 ...
	 *
	 * @return  return   <code>OdfName</code> the name of element {@odf.element db:java-classpath}.
	 */
	...
	/**
	 * Initialization of the mandatory attributes of {@link  DbJavaClasspathElement}
	 *
