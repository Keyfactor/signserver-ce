...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "layer-set" );
	 ...
	 * @return   return  the element {@odf.element draw:layer}
	 * DifferentQName 
	 */
    
	public DrawLayerElement newDrawLayerElement(String drawNameAttributeValue)
	{
		DrawLayerElement  drawLayer = ((OdfFileDom)this.ownerDocument).newOdfElement(DrawLayerElement.class);
		drawLayer.setDrawNameAttribute( drawNameAttributeValue );
