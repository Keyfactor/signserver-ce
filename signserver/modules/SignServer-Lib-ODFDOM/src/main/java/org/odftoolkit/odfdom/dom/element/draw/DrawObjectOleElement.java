...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "object-ole" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  DrawObjectOleElement}
	 *
