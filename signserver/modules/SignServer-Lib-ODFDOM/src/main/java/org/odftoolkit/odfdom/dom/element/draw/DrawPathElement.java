...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "path" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  DrawPathElement}
	 *
