 ...
 *
 */
public abstract class FormComboboxElement extends OdfElement
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "combobox" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  FormComboboxElement}
	 *
	...
	{
		FormAutoCompleteAttribute attr = (FormAutoCompleteAttribute) getOdfAttribute( OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "auto-complete" ) );
		if( attr != null ){
			return Boolean.valueOf( attr.booleanValue() );
		}
		return null;
	 ...
	 *
	 * @return   return  the element {@odf.element form:item}
	 * DifferentQName 
	 */
