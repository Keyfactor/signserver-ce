 ...
 *
 */
public abstract class FormDateElement extends OdfElement
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "date" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  FormDateElement}
	 *
