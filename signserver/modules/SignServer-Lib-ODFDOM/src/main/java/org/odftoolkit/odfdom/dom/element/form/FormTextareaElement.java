...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "textarea" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  FormTextareaElement}
	 *
