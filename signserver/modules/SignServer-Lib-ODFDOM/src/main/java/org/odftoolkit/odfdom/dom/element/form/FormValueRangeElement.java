...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "value-range" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  FormValueRangeElement}
	 *
	...
	{
		FormMaxValueAttribute attr = (FormMaxValueAttribute) getOdfAttribute( OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "max-value" ) );
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
	...
	{
		FormMinValueAttribute attr = (FormMinValueAttribute) getOdfAttribute( OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "min-value" ) );
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
	...
	{
		FormStepSizeAttribute attr = (FormStepSizeAttribute) getOdfAttribute( OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "step-size" ) );
		if( attr != null ){
			return Integer.valueOf( attr.intValue() );
		}
	...
	{
		FormPageStepSizeAttribute attr = (FormPageStepSizeAttribute) getOdfAttribute( OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "page-step-size" ) );
		if( attr != null ){
			return Integer.valueOf( attr.intValue() );
		}
		return null;
	...
	{
		FormOrientationAttribute attr = (FormOrientationAttribute) getOdfAttribute( OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "orientation" ) );
		if( attr != null ){
			return String.valueOf( attr.getValue() );
		}
		return null;
