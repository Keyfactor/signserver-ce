 ...
 *
 */
public abstract class MetaKeywordElement extends OdfElement
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.META), "keyword" );
