 ...
 *
 */
public abstract class NumberAmPmElement extends OdfElement
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.NUMBER), "am-pm" );
