 ...
 *
 */
public abstract class NumberTextStyleElement extends OdfElement
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.NUMBER), "text-style" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  NumberTextStyleElement}
	 *
	 ...
	 *
	 * @return   return  the element {@odf.element number:text-content}
	 * DifferentQName 
	 */
