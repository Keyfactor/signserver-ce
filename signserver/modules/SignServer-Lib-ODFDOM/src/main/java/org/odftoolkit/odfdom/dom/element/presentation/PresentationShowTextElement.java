 ...
 *
 */
public abstract class PresentationShowTextElement extends OdfElement
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.PRESENTATION), "show-text" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  PresentationShowTextElement}
	 *
