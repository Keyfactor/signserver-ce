...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.SVG), "font-face-uri" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  SvgFontFaceUriElement}
	 *
	 ...
	 *
	 * @return   return  the element {@odf.element svg:font-face-format}
	 * DifferentQName 
	 */
