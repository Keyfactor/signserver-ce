 ...
 *
 */
public abstract class TableCellContentChangeElement extends OdfElement
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "cell-content-change" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  TableCellContentChangeElement}
	 *
	 ...
	 *
     * @param tableColumnAttributeValue  the <code>int</code> value of <code>TableColumnAttribute</code>, see {@odf.attribute  table:column} at specification
	 * @param tableRowAttributeValue  the <code>int</code> value of <code>TableRowAttribute</code>, see {@odf.attribute  table:row} at specification
	 * @param tableTableAttributeValue  the <code>int</code> value of <code>TableTableAttribute</code>, see {@odf.attribute  table:table} at specification
	 * @return   return  the element {@odf.element table:cell-address}
	 * DifferentQName 
	 */
    
	public TableCellAddressElement newTableCellAddressElement(int tableColumnAttributeValue, int tableRowAttributeValue, int tableTableAttributeValue)
	{
		TableCellAddressElement  tableCellAddress = ((OdfFileDom)this.ownerDocument).newOdfElement(TableCellAddressElement.class);
		tableCellAddress.setTableColumnAttribute( Integer.valueOf(tableColumnAttributeValue) );
		tableCellAddress.setTableRowAttribute( Integer.valueOf(tableRowAttributeValue) );
		tableCellAddress.setTableTableAttribute( Integer.valueOf(tableTableAttributeValue) );
	 ...
	 *
	 * @return   return  the element {@odf.element table:previous}
	 * DifferentQName 
	 */
