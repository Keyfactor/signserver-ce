...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "cell-content-deletion" );
	 ...
	 *
	 * @return   return  the element {@odf.element table:change-track-table-cell}
	 * DifferentQName 
	 */
	public TableChangeTrackTableCellElement newTableChangeTrackTableCellElement()
	{
