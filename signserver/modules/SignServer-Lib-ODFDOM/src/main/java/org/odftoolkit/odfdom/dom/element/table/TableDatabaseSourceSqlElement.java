...
{        
	...
	/**
	 * Initialization of the mandatory attributes of {@link  TableDatabaseSourceSqlElement}
	 *
     * @param tableDatabaseNameAttributeValue  The mandatory attribute {@odf.attribute  table:database-name}"
     * @param tableSqlStatementAttributeValue  The mandatory attribute {@odf.attribute  table:sql-statement}"
     *
	 */
	public void init(String tableDatabaseNameAttributeValue, String tableSqlStatementAttributeValue)
	{
		setTableDatabaseNameAttribute( tableDatabaseNameAttributeValue );
		setTableSqlStatementAttribute( tableSqlStatementAttributeValue );
	}
