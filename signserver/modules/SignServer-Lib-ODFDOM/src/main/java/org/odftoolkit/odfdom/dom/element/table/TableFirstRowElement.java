...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "first-row" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  TableFirstRowElement}
	 *
