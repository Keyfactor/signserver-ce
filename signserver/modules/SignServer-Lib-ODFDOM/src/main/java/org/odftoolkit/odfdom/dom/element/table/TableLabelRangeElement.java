...
{        
	...
	/**
	 * Initialization of the mandatory attributes of {@link  TableLabelRangeElement}
	 *
     * @param tableLabelCellRangeAddressAttributeValue  The mandatory attribute {@odf.attribute  table:label-cell-range-address}"
     * @param tableDataCellRangeAddressAttributeValue  The mandatory attribute {@odf.attribute  table:data-cell-range-address}"
     * @param tableOrientationAttributeValue  The mandatory attribute {@odf.attribute  table:orientation}"
     *
	 */
	public void init(String tableLabelCellRangeAddressAttributeValue, String tableDataCellRangeAddressAttributeValue, String tableOrientationAttributeValue)
	{
		setTableLabelCellRangeAddressAttribute( tableLabelCellRangeAddressAttributeValue );
		setTableDataCellRangeAddressAttribute( tableDataCellRangeAddressAttributeValue );
