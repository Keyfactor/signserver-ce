...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "table-cell" );
	 ...
	 *
     * @param tableLastColumnSpannedAttributeValue  the <code>int</code> value of <code>TableLastColumnSpannedAttribute</code>, see {@odf.attribute  table:last-column-spanned} at specification
	 * @param tableLastRowSpannedAttributeValue  the <code>int</code> value of <code>TableLastRowSpannedAttribute</code>, see {@odf.attribute  table:last-row-spanned} at specification
	 ...
	 * @return   return  the element {@odf.element table:cell-range-source}
	 * DifferentQName 
	 */
    
	public TableCellRangeSourceElement newTableCellRangeSourceElement(int tableLastColumnSpannedAttributeValue, int tableLastRowSpannedAttributeValue, String tableNameAttributeValue, String xlinkHrefAttributeValue, String xlinkTypeAttributeValue)
	{
		...
		tableCellRangeSource.setTableLastColumnSpannedAttribute( Integer.valueOf(tableLastColumnSpannedAttributeValue) );
		tableCellRangeSource.setTableLastRowSpannedAttribute( Integer.valueOf(tableLastRowSpannedAttributeValue) );
		tableCellRangeSource.setTableNameAttribute( tableNameAttributeValue );
		tableCellRangeSource.setXlinkHrefAttribute( xlinkHrefAttributeValue );
		tableCellRangeSource.setXlinkTypeAttribute( xlinkTypeAttributeValue );
	 ...
	 *
	 * @return   return  the element {@odf.element table:detective}
	 * DifferentQName 
	 */
