 ...
 *
 */
public abstract class TextBibliographyElement extends OdfStylableElement
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "bibliography" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  TextBibliographyElement}
	 *
	 ...
	 *
	 * @return   return  the element {@odf.element text:bibliography-source}
	 * DifferentQName 
	 */
