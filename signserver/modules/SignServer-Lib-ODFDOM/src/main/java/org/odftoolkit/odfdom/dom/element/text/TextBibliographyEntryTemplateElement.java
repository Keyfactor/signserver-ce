...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "bibliography-entry-template" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  TextBibliographyEntryTemplateElement}
	 *
     ...
     *
	 */
	public void init(String textBibliographyTypeAttributeValue, String textStyleNameAttributeValue)
	{
	 ...
	 *
     * @param textBibliographyDataFieldAttributeValue  the <code>String</code> value of <code>TextBibliographyDataFieldAttribute</code>, see {@odf.attribute  text:bibliography-data-field} at specification
	 * @return   return  the element {@odf.element text:index-entry-bibliography}
	 * DifferentQName 
	 */
    
	public TextIndexEntryBibliographyElement newTextIndexEntryBibliographyElement(String textBibliographyDataFieldAttributeValue)
	{
		...
		textIndexEntryBibliography.setTextBibliographyDataFieldAttribute( textBibliographyDataFieldAttributeValue );
