...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "database-name" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  TextDatabaseNameElement}
	 *
