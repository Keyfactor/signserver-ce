...
{        
	...
	/**
	 * Initialization of the mandatory attributes of {@link  TextIndexSourceStylesElement}
	 *
     * @param textOutlineLevelAttributeValue  The mandatory attribute {@odf.attribute  text:outline-level}"
     *
	 */
	public void init(String textOutlineLevelAttributeValue)
	{
	}
	 ...
	 * @return   return  the element {@odf.element text:index-source-style}
	 * DifferentQName 
	 */
    
	public TextIndexSourceStyleElement newTextIndexSourceStyleElement(String textStyleNameAttributeValue)
	{
		...
		textIndexSourceStyle.setTextStyleNameAttribute( textStyleNameAttributeValue );
