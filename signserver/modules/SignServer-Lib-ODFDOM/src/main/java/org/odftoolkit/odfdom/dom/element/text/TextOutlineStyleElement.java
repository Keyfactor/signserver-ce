...
{        
	...
	/**
	 * Initialization of the mandatory attributes of {@link  TextOutlineStyleElement}
	 *
	 ...
	 * @return   return  the element {@odf.element text:outline-level-style}
	 * DifferentQName 
	 */
    
	public TextOutlineLevelStyleElement newTextOutlineLevelStyleElement(String styleNumFormatAttributeValue, int textLevelAttributeValue)
	{
		...
		textOutlineLevelStyle.setStyleNumFormatAttribute( styleNumFormatAttributeValue );
		textOutlineLevelStyle.setTextLevelAttribute( Integer.valueOf(textLevelAttributeValue) );
