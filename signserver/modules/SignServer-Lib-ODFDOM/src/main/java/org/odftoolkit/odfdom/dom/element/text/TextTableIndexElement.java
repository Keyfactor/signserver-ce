...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "table-index" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  TextTableIndexElement}
	 *
	 ...
	 *
	 * @return   return  the element {@odf.element text:table-index-source}
	 * DifferentQName 
	 */
