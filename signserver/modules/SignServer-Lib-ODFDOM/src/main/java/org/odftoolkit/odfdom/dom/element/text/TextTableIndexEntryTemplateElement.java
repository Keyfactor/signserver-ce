...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "table-index-entry-template" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  TextTableIndexEntryTemplateElement}
	 *
