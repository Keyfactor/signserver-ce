...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "table-index-source" );
	 ...
	 * @return   return  the element {@odf.element text:table-index-entry-template}
	 * DifferentQName 
	 */
    
	public TextTableIndexEntryTemplateElement newTextTableIndexEntryTemplateElement(String textStyleNameAttributeValue)
	{
		...
		textTableIndexEntryTemplate.setTextStyleNameAttribute( textStyleNameAttributeValue );
