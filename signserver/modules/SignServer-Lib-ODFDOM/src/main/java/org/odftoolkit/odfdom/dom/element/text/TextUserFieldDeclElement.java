...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "user-field-decl" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  TextUserFieldDeclElement}
	 *
