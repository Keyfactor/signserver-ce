...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "user-index-mark-end" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  TextUserIndexMarkEndElement}
	 *
