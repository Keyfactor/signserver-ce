...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "variable-get" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  TextVariableGetElement}
	 *
