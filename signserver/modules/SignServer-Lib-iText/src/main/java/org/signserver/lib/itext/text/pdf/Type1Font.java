...
import org.signserver.lib.itext.text.pdf.fonts.FontsResourceAnchor;
    ...
    Type1Font(String afmFile, String enc, boolean emb, byte ttfAfm[], byte pfb[], boolean forceRead)
        ...
        if (BuiltinFonts14.containsKey(afmFile)) {
            ...
            try {
                ...
                if (is == null) {
                    String msg = afmFile + " not found as resource. (The *.afm files must exist as resources in the package org.signserver.lib.itext.text.pdf.fonts)";
