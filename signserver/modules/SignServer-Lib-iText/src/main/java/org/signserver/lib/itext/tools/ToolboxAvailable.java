...
public class ToolboxAvailable {
	...
	public static void main(String[] args) {
		...
		try {
			Class c = Class.forName("org.signserver.lib.itext.toolbox.Toolbox");
			Method toolboxMain = c.getMethod("main", new Class[] {args.getClass()});
			toolboxMain.invoke(null, new Object[] {args} );
		} catch (Exception e) {
			JOptionPane.showMessageDialog(null,
					"You need the iText-toolbox.jar with class org.signserver.lib.itext.toolbox.Toolbox to use the iText Toolbox.",
