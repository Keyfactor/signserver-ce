...
public class RenewalTimedService extends BaseTimedService {
    ...
    public void init(int workerId, WorkerConfig config,
        ...
        if (value == null) {
            ...
            workers = new ArrayList<String>(parts.length);
    ...
    public WorkerStatus getStatus(List<String> additionalFatalErrors, final IServices services) {
        ...
        try {
            ...
            LOG.error("Unable to lookup internal session beans", ex);
        }
            ...
            if (status.workerId == 0) {
                ...
                if (status.renewalWorker == null) {
                    ...
                    if (renewTime == null) {
                        ...
                        try {
                            final Date notAfter = workerSession.getSigningValidityNotAfter(status.workerId);
