// copied from BouncyCastle 1.47, modified to always include the ordering field if non-null (TimeStampTokenGenerator was
// modified to allow setting ordering even when the value is false).
