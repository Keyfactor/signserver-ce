...
/**
 * Abstract base implementation for time stamp signers.
 * Exposes an abstract method for generating timestamp extensions that
 * concreate implementations will implement.
 *
 * @author Marcus Lundblad
 * @version $Id$
 */
public abstract class BaseTimeStampSigner extends BaseSigner {
     ...
     */
    protected abstract Extensions getAdditionalExtensions(ProcessRequest request,
