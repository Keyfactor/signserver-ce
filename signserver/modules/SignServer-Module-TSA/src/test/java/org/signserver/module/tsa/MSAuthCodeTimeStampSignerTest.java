...
public class MSAuthCodeTimeStampSignerTest extends ModulesTestCase {
    ...
    private void testProcessDataWithAlgo(final String signingAlgo, final String expectedDigestOID,
        ...
        try (
            ...
            resp = (SignatureResponse) workerMock.process(new AdminInfo("Client user", null, null), new WorkerIdentifier(SIGNER_ID), Optional.empty(), Optional.empty(), signRequest, new MockedRequestContext(services));
    ...
    public void testNoSigningWhenWorkerMisconfigued() throws Exception {
        ...
        try (
            ...
            workerMock.process(new AdminInfo("Client user", null, null), new WorkerIdentifier(SIGNER_ID), Optional.empty(), Optional.empty(), signRequest, new MockedRequestContext(services));
