 ...
 */
public class LegacyPKCS11CryptoToken extends BaseCryptoToken implements P11SlotUser {
     ...
     */
    public LegacyPKCS11CryptoToken() throws InstantiationException {
        super();
        try {
    ...
    public void init(final Properties properties, final byte[] data, final int id) throws CryptoTokenOfflineException, NoSuchSlotException {
        ...
        String sharedLibrary = properties.getProperty(LegacyPKCS11CryptoToken.SHLIB_LABEL_KEY);
        String attributesFile = properties.getProperty(LegacyPKCS11CryptoToken.ATTRIB_LABEL_KEY);
        // If doNotAddP11Provider is set to true, this boolean is set to false
        Boolean addProvider = !BooleanUtils.toBoolean(properties.getProperty(LegacyPKCS11CryptoToken.DO_NOT_ADD_P11_PROVIDER));
