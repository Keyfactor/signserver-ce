...
public class ValidationCLITest extends ModulesTestCase {
    ...
    public void test00SetupDatabase() throws Exception {
        ...
        X509Certificate validSubCA1 = ValidationTestUtils.genCert(1000000, "SHA256withRSA", "CN=ValidSubCA1", validRootCA1Keys.getPrivate(), validSubCA1Keys.getPublic(), new Date(0), new Date(System.currentTimeMillis() + 1000000), true);

        KeyPair validCert1Keys = KeyTools.genKeys("1024", "RSA");
        validCert1 = new String(Base64.encode(ValidationTestUtils.genCert(1000000, "SHA256withRSA", "CN=ValidCert1", validSubCA1Keys.getPrivate(), validCert1Keys.getPublic(), new Date(0), new Date(System.currentTimeMillis() + 1000000), false, X509KeyUsage.digitalSignature + X509KeyUsage.keyEncipherment).getEncoded()));
