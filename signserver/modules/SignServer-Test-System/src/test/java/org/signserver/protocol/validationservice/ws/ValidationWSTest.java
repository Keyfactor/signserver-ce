...
public class ValidationWSTest extends ModulesTestCase {
    ...
    public void test00SetupDatabase() throws Exception {
        ...
        validCert1 = new String(Base64.encode(ValidationTestUtils.genCert(1000000, "CN=ValidCert1", "CN=ValidSubCA1", validSubCA1Keys.getPrivate(), validCert1Keys.getPublic(), new Date(0), new Date(System.currentTimeMillis() + 1000000), false).getEncoded()));
        ...
        identificationCert1 = new String(Base64.encode(ValidationTestUtils.genCert(1000000, "CN=identificationCert1", "CN=ValidSubCA1", validSubCA1Keys.getPrivate(), validCert1Keys.getPublic(), new Date(0), new Date(System.currentTimeMillis() + 1000000), false, X509KeyUsage.digitalSignature + X509KeyUsage.keyEncipherment).getEncoded()));
