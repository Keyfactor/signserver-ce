...
import static org.signserver.server.archive.test1archiver.Test1Archiver.CLASSNAME;
import static org.signserver.server.archive.test1archiver.Test1Archiver.INSTANCE;
import static org.signserver.server.archive.test1archiver.Test1Archiver.LISTINDEX;
import static org.signserver.server.archive.test1archiver.Test1Archiver.PROCESSED;
import static org.signserver.server.archive.test1archiver.Test1Archiver.WORKERID;
...
public class ArchiveAPITest extends ModulesTestCase {
    ...
    public void test02ThreeArchiversCalled() throws Exception {
        ...
        assertNotEquals("a0 != a1", archive0.getProperty(INSTANCE), archive1.getProperty(INSTANCE));
        assertNotEquals("a1 != a2", archive1.getProperty(INSTANCE), archive2.getProperty(INSTANCE));
