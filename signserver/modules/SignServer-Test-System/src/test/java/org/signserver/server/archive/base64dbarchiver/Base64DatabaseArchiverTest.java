...
public class Base64DatabaseArchiverTest extends ArchiveTestCase {
     ...
     */
    @Test
    public void test68archiveNoRequestArchivingAndArchiveRequestNotAllowed() throws Exception {
        final int signerId = getSignerIdDummy1();
     ...
     */
    @Test
    public void test69archiveNoRequestArchivingAndArchiveResponseAllowed() throws Exception {
        final int signerId = getSignerIdDummy1();
     ...
     */
    @Test
    public void test70archiveNoRequestArchivingAndArchiveRequestResponseNotAllowed() throws Exception {
        final int signerId = getSignerIdDummy1();
