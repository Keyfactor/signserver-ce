...
public class CRLValidatorTest extends ModulesTestCase {
    ...
    public void test00SetupDatabase() throws Exception {
        ...
        certRootCA1 = ValidationTestUtils.genCert(1000000, "SHA256withRSA", "CN=RootCA1", keysRootCA1.getPrivate(), keysRootCA1.getPublic(),
                new Date(0), new Date(System.currentTimeMillis() + 1000000), true);

        KeyPair keysEndEntity1 = KeyTools.genKeys("1024", "RSA");
        certEndEntity1 = ValidationTestUtils.genCert(1000000, "SHA256withRSA", "CN=EndEntity1", keysRootCA1.getPrivate(), keysEndEntity1.getPublic(),
        ...
        certEndEntity2 = ValidationTestUtils.genCert(1000000, "SHA256withRSA", "CN=EndEntity2", keysRootCA1.getPrivate(), keysEndEntity2.getPublic(),
                new Date(0), new Date(System.currentTimeMillis() + 1000000), false, 0, crlDistPointCA1WithUrl);

        KeyPair keysEndEntity5 = KeyTools.genKeys("1024", "RSA");
        certEndEntity5Expired = ValidationTestUtils.genCert(1000000, "SHA256withRSA", "CN=EndEntity5", keysRootCA1.getPrivate(), keysEndEntity5.getPublic(),
        ...
        certEndEntity6NotYetValid = ValidationTestUtils.genCert(1000000, "SHA256withRSA", "CN=EndEntity6", keysRootCA1.getPrivate(), keysEndEntity6.getPublic(),
        ...
        certEndEntity7WrongIssuer = ValidationTestUtils.genCert(1000000, "SHA256withRSA", "CN=EndEntity7", notKeyOfRootCA1, keysEndEntity7.getPublic(),
                new Date(0), new Date(System.currentTimeMillis() + 1000000), false, 0, crlDistPointCA1WithUrl);

        KeyPair keysEndEntity8 = KeyTools.genKeys("1024", "RSA");
        certEndEntity8KeyUsageSig = ValidationTestUtils.genCert(1000000, "SHA256withRSA", "CN=EndEntity8", keysRootCA1.getPrivate(), keysEndEntity8.getPublic(),
        ...
        certEndEntity3 = ValidationTestUtils.genCert(1000000, "SHA256withRSA", "CN=EndEntity3", keysRootCA2.getPrivate(), keysEndEntity3.getPublic(),
        ...
        certEndEntity4 = ValidationTestUtils.genCert(1000000, "SHA256withRSA", "CN=EndEntity4", keysRootCA2.getPrivate(), keysEndEntity4.getPublic(),
                new Date(0), new Date(System.currentTimeMillis() + 1000000), false, 0, crlDistPointCA2WithIssuer);
