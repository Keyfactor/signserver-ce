...
public class DataBankManagerTest extends CommonManagerT {
    ...
    public void test01DataBankManager() throws Exception {
        ...
        tb();
        dm.setProperty(WSRAConstants.DATABANKTYPE_PRICE, "key1", "value1");
        tc();
        tb();
        dm.setProperty(WSRAConstants.DATABANKTYPE_PRICE, "key2", "value2");
        tc();
        tb();
        dm.setProperty(WSRAConstants.DATABANKTYPE_PRICE, "key3", "value3");
        tc();
        tb();
        dm.setProperty(WSRAConstants.DATABANKTYPE_GENERAL, "key1", "value4");
        tc();
        tb();
        dm.setProperty(WSRAConstants.DATABANKTYPE_GENERAL, "key2", "value5");
        tc();
        ...
        tb();
        dm.removePropery(WSRAConstants.DATABANKTYPE_PRICE, "key3");
        tc();
    ...
    public void test01RelatedData() throws Exception {
        ...
        tb();
        dm.setRelatedProperty(WSRAConstants.DATABANKTYPE_ORGANIZATION, 111, "key1", "value1");
        tc();
        tb();
        dm.setRelatedProperty(WSRAConstants.DATABANKTYPE_ORGANIZATION, 111, "key2", "value2");
        tc();
        tb();
        dm.setRelatedProperty(WSRAConstants.DATABANKTYPE_ORGANIZATION, 111, "key3", "value3");
        tc();
