...
public class OrganizationManagerTest extends CommonManagerT {
    ...
    public void test02ProductsInOrganizationRelation() throws Exception {
        ...
        tb();
        om.editProductInOrganization(pio1);
        tc();
        ...
        tb();
        om.editProductInOrganization(pio2);
        tc();
        ...
        tb();
        om.editProductInOrganization(pio);
        tc();
        ...
        tb();
        om.removeProductInOrganization(pio2.getOrganizationId(), pio2.getProductId());
        tc();
    ...
    public void test03RemoveOrganization() throws Exception {
        ...
        tb();
        om.removeOrganization(result.getId());
        tc();
        result = om.findOrganization("testOrg1");
        assertNull(result);
