...
public class WSRATest extends CommonManagerT {
    ...
    protected void setUp() throws Exception {
        ...
        if (um == null) {
            ...
            tb();
            um.editAuthData(new AuthDataBean(at.getAuthType(), at.getMatchValue(raadmin1ctx), ud.getId()));
            tc();
            ...
            tb();
            um.editAuthData(new AuthDataBean(at.getAuthType(), at.getMatchValue(user2ctx), ud.getId()));
            tc();
            ...
            tb();
            um.editAuthData(new AuthDataBean(at.getAuthType(), at.getMatchValue(sactx), ud.getId()));
            tc();
            ...
            tb();
            um.editAuthData(new AuthDataBean(at.getAuthType(), at.getMatchValue(smtpctx), ud.getId()));
            tc();
            ...
            tb();
            um.editAuthData(new AuthDataBean(at.getAuthType(), at.getMatchValue(smtpadmctx), ud.getId()));
            tc();
            ...
            tb();
            um.editAuthData(new AuthDataBean(at.getAuthType(), at.getMatchValue(userctx), ud.getId()));
            tc();
...
//		try
        {
            WSRA wSRA = genWSRA(workerId, workerEntityManager, wc, user2ctx, null);
            tb();
            wSRA.generateCertificateFromPKCS10("test1", pkcs10, null);
            tc();
            assertTrue(false);
        }
//                        catch(AuthorizationDeniedException e){
...
//		}
        ...
        pkcs10 = new PKCS10CertRequestData("cProfile1", "RFC822Name=test@test.se",
                ...
                keys.getPrivate(), "BC");
        tb();
        Certificate cert = wSRA.generateCertificateFromPKCS10("test1", pkcs10, null);
        tc();
        assertNotNull(cert);
...
//		}
        ...
        tb();
        cert = wSRA.generateCertificateFromPKCS10("test1", pkcs10, "12345");
        tc();
        assertNotNull(cert);
...
//		try{
        tb();
        wSRA.generateCertificateFromPKCS10("test2", pkcs10, "12345");
        tc();
        assertTrue(false);
//		}catch(IllegalRequestException e){
//			tr();
...
//		}catch(AuthorizationDeniedException e){}
        ...
        tb();
        tdb = wSRA.generateSoftToken("test1", "foo123", requests, JKSTokenProfile.PROFILEID, null, false);
        tc();
        assertNotNull(tdb);
        ...
        try {
            tb();
            wSRA.generateSoftToken("test1", "foo123", requests, JKSTokenProfile.PROFILEID, tokenSN, false);
            tc();
            assertTrue(false);
        } catch (IllegalRequestException e) {
            tr();
        ...
        tb();
        wSRA.generateSoftToken("test1", "foo123", requests, JKSTokenProfile.PROFILEID, tokenSN, true);
        tc();
        ...
        try {
            ...
            tb();
            wSRA.generateSoftToken("test1", "foo123", requests2, JKSTokenProfile.PROFILEID, null, false);
            tc();
            assertTrue(false);
        } catch (IllegalRequestException e) {
            tr();
        ...
        tb();
        tdb = wSRA.generateSoftToken("test2", "foo123", requests, SMTPTokenProfile.PROFILEID, null, false);
        tc();
        assertNotNull(tdb);
        assertNotNull(tdb.getSerialNumber());
        assertNotNull(tdb.getSensitiveData());
        ...
        try {
            tb();
            wSRA.revokeUser("test1", WSRAConstants.REVOKATION_REASON_AACOMPROMISE, UserStatus.DISABLED);
            tc();
        } catch (AuthorizationDeniedException e) {
            tr();
        }
