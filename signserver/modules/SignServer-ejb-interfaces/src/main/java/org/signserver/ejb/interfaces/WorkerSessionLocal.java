...
public interface WorkerSessionLocal extends WorkerSession {
     ...
     */
    default KeyAttestation getKeyAttestation(final AdminInfo adminInfo, final WorkerIdentifier signerId, String alias)
     ...
     */
    WorkerConfig getCurrentWorkerConfig(final AdminInfo adminInfo, int signerId);
}
