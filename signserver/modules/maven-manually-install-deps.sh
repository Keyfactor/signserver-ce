...
mvn install:install-file -Dfile=lib/ext/cesecore-ejb-interfaces-7.0.0.1.jar -DgroupId=org.ejbca.cesecore -DartifactId=cesecore-ejb-interfaces -Dversion=7.0.0.1 -Dpackaging=jar &&
