...
mvn install:install-file -Dfile=lib/ext/DeployTools-Common-1.1.jar -DgroupId=org.signserver.deploytools -DartifactId=DeployTools-Common -Dversion=1.1 -Dpackaging=jar
mvn install:install-file -Dfile=lib/ext/DeployTools-Maven-1.1.jar -DgroupId=org.signserver.deploytools -DartifactId=DeployTools-Maven -Dversion=1.1 -Dpackaging=jar
