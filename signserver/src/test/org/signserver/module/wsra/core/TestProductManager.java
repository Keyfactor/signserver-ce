...
public class TestProductManager extends CommonManagerTest {
	...
	public void test01Products() throws Exception{
		...
		tb();pm.editProduct(prod1);tc();
		tb();pm.editProduct(prod2);tc();
		tb();pm.editProduct(prod3);tc();
		...
		tb();pm.removeProduct(prodId1);tc();
		tb();pm.removeProduct(prodId1);tc();
		tb();pm.removeProduct(prodId2);tc();
	...
	public void test02Prices() throws Exception{
		...
		tb();pm.editPrice(price1);tc();
		tb();pm.editPrice(price2);tc();
		tb();pm.editPrice(price3);tc();
		...
		tb();pm.removePrice(priceId1);tc();
		tb();pm.removePrice(priceId1);tc();
		tb();pm.removePrice(priceId2);tc();
