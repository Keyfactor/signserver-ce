...
public class TestTokenManager extends CommonManagerTest {
	...
	public void test03RemoveTokens() throws Exception{
		...
		tb();tm.editToken(t);tc();
		
		tb();um.removeUser(userId1);tc();
        ...
        tb();tm.editCertificate(certData1);tc();
        ...
        tb();tm.removeCertificate(res.getId());tc();
        assertNull(tm.findCertificateByFingerprint(CertTools.getFingerprintAsString(cert1)));
