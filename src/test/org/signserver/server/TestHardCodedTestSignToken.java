...
import org.signserver.server.signtokens.HardCodedSignToken;
import org.signserver.server.signtokens.ISignToken;
 

public class TestHardCodedTestSignToken extends TestCase {
	...
	public void testGetPrivateKey() throws Exception {
        ...
        HardCodedSignToken signToken = new HardCodedSignToken();
        signToken.init(null);
        ...
        sig.initSign(signToken.getPrivateKey(ISignToken.PURPOSE_SIGN));
        ...
        sig.initVerify(signToken.getPublicKey(ISignToken.PURPOSE_SIGN));
        sig.update("Hello World".getBytes());
