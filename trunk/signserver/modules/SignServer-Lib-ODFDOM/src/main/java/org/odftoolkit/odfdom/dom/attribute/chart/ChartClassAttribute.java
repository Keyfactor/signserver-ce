...
public class ChartClassAttribute extends OdfAttribute {
	...
	public void setValue(String attrValue) {
		...
		if( parentElement != null ){
			try {
				...
				}else if( parentElement instanceof ChartGridElement ){
					super.setValue(ChartGridElement.ChartClassAttributeValue.enumValueOf(attrValue).toString());
				}else if( parentElement instanceof ChartSeriesElement ){
					//2DO: need validate value against NamespacedToken
					super.setValue(attrValue);
				}			
		...
		if( parentElement != null ){
			try {
				if( parentElement instanceof ChartChartElement ){
					...
					return ChartGridElement.ChartClassAttributeValue.enumValueOf(super.getValue()).toString();
				}else if( parentElement instanceof ChartSeriesElement ){
					//2DO: need validate value against NamespacedToken
					return super.getValue();
				}			
				...
				// TODO: validation handling/logging
				throw new NumberFormatException("the value of chart:class is not valid");
			}
		}else{
			//2DO:what should do when the owner element is null?
			return super.getValue();
	...
	/**
	 * Returns the default value of {@odf.attribute chart:class} dependent of its element name
	 * 
