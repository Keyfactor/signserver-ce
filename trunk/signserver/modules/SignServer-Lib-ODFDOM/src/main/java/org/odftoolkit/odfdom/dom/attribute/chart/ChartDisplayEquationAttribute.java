...
public class ChartDisplayEquationAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.CHART), "display-equation" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of chart:display-equation is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute chart:display-equation} dependent of its element name
	 * 
