...
public class ChartDisplayRSquareAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.CHART), "display-r-square" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of chart:display-r-square is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute chart:display-r-square} dependent of its element name
	 * 
