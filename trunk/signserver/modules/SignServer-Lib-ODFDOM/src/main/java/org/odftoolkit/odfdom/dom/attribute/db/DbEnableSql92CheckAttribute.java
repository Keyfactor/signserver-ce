...
public class DbEnableSql92CheckAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "enable-sql92-check" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of db:enable-sql92-check is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute db:enable-sql92-check} dependent of its element name
	 * 
