...
public class DbEncodingAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "encoding" );
	...
	public void setValue(String attrValue) {
		try{
			//2DO: need validate value against TextEncoding
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of db:encoding is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute db:encoding} dependent of its element name
	 * 
