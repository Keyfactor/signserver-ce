...
public class DrawExtrusionAllowedAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "extrusion-allowed" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of draw:extrusion-allowed is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute draw:extrusion-allowed} dependent of its element name
	 * 
