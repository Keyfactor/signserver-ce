...
public class DrawExtrusionFirstLightHarshAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "extrusion-first-light-harsh" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of draw:extrusion-first-light-harsh is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute draw:extrusion-first-light-harsh} dependent of its element name
	 * 
