...
public class DrawExtrusionSpecularityAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "extrusion-specularity" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of draw:extrusion-specularity is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute draw:extrusion-specularity} dependent of its element name
	 * 
