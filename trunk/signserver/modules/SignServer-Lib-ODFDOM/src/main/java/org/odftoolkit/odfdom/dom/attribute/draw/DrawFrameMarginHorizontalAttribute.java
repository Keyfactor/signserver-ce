...
public class DrawFrameMarginHorizontalAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DRAW), "frame-margin-horizontal" );
	...
	public void setValue(String attrValue) {
		try{
			//2DO: need validate value against NonNegativePixelLength
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of draw:frame-margin-horizontal is not valid");
		}
	}
