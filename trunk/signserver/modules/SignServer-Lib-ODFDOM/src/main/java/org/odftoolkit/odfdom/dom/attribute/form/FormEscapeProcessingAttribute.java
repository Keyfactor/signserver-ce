...
public class FormEscapeProcessingAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "escape-processing" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of form:escape-processing is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute form:escape-processing} dependent of its element name
	 * 
