...
public class FormSpinButtonAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "spin-button" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of form:spin-button is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute form:spin-button} dependent of its element name
	 * 
