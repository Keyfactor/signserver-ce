...
public class NumberAutomaticOrderAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.NUMBER), "automatic-order" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of number:automatic-order is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute number:automatic-order} dependent of its element name
	 * 
