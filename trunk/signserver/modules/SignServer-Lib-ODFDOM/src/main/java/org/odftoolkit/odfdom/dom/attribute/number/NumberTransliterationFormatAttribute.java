...
public class NumberTransliterationFormatAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.NUMBER), "transliteration-format" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of number:transliteration-format is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute number:transliteration-format} dependent of its element name
	 * 
