...
public class PresentationDirectionAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.PRESENTATION), "direction" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of presentation:direction is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute presentation:direction} dependent of its element name
	 * 
