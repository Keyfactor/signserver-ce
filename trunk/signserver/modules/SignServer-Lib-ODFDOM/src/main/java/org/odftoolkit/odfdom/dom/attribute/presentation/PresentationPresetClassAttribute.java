...
public class PresentationPresetClassAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.PRESENTATION), "preset-class" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of presentation:preset-class is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute presentation:preset-class} dependent of its element name
	 * 
