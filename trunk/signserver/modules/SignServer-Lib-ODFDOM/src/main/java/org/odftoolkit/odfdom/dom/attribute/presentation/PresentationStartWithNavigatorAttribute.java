...
public class PresentationStartWithNavigatorAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.PRESENTATION), "start-with-navigator" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of presentation:start-with-navigator is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute presentation:start-with-navigator} dependent of its element name
	 * 
