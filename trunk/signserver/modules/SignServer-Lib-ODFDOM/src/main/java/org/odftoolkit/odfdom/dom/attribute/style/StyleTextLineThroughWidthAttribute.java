...
public class StyleTextLineThroughWidthAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.STYLE), "text-line-through-width" );
	...
	public void setValue(String attrValue) {
		try{
			//2DO: need validate value against positiveInteger;percent;positiveLength;enum
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of style:text-line-through-width is not valid");
		}
	}
