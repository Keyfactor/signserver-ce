...
public class SvgRyAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.SVG), "ry" );
	...
	public void setValue(String attrValue) {
		...
		if( parentElement != null ){
			try {
				if( parentElement instanceof DrawEllipseElement ){
					//2DO: need validate value against Length
					super.setValue(attrValue);
				}else if( parentElement instanceof DrawRectElement ){
					//2DO: need validate value against NonNegativeLength
					super.setValue(attrValue);
				}			
	...
	public String getValue(){
		...
		if( parentElement != null ){
			try {
				...
				// TODO: validation handling/logging
				throw new NumberFormatException("the value of svg:ry is not valid");
			}
		}else{
			//2DO:what should do when the owner element is null?
			return super.getValue();
