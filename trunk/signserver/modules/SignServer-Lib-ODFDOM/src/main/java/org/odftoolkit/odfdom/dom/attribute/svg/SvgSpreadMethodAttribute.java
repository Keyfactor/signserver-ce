...
public class SvgSpreadMethodAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.SVG), "spreadMethod" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of svg:spreadMethod is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute svg:spreadMethod} dependent of its element name
	 * 
