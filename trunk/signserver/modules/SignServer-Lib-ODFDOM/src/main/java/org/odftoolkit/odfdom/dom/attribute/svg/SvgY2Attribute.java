...
public class SvgY2Attribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.SVG), "y2" );
	...
	public String getValue(){
		...
		if( parentElement != null ){
			try {
				...
				// TODO: validation handling/logging
				throw new NumberFormatException("the value of svg:y2 is not valid");
			}
		}else{
			//2DO:what should do when the owner element is null?
			return super.getValue();
	...
	/**
	 * Returns the default value of {@odf.attribute svg:y2} dependent of its element name
	 * 
