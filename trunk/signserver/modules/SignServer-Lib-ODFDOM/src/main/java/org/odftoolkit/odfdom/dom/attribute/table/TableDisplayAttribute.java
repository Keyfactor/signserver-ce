...
public class TableDisplayAttribute extends OdfAttribute {
	...
	/**
	 * Returns the default value of {@odf.attribute table:display} dependent of its element name
	 * 
	...
	public String getDefault() {
		...
		if (parentElement != null) {
			...
			}else if( parentElement instanceof TableHelpMessageElement ){
				defaultValue = DEFAULT_VALUE_FALSE;
			}else if( parentElement instanceof TableTableColumnGroupElement ){
				defaultValue = DEFAULT_VALUE_TRUE;
			}else if( parentElement instanceof TableTableRowGroupElement ){
				defaultValue = DEFAULT_VALUE_TRUE;
			}			
		}
		return defaultValue;
