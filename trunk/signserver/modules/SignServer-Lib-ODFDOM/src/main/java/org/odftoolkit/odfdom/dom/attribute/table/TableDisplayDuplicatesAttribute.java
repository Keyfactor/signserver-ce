...
public class TableDisplayDuplicatesAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "display-duplicates" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:display-duplicates is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:display-duplicates} dependent of its element name
	 * 
