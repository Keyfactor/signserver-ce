...
public class TableEmbeddedNumberBehaviorAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "embedded-number-behavior" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:embedded-number-behavior is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:embedded-number-behavior} dependent of its element name
	 * 
