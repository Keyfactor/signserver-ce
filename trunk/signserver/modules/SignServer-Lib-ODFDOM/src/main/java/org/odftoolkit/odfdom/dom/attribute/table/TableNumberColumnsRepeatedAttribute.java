...
public class TableNumberColumnsRepeatedAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "number-columns-repeated" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:number-columns-repeated is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:number-columns-repeated} dependent of its element name
	 * 
