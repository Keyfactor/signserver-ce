...
public class TableNumberRowsRepeatedAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "number-rows-repeated" );
	...
	/**
	 * Returns the default value of {@odf.attribute table:number-rows-repeated} dependent of its element name
	 * 
