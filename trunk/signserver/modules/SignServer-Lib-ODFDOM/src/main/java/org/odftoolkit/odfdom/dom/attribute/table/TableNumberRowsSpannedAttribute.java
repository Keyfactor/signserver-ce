...
public class TableNumberRowsSpannedAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "number-rows-spanned" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:number-rows-spanned is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:number-rows-spanned} dependent of its element name
	 * 
