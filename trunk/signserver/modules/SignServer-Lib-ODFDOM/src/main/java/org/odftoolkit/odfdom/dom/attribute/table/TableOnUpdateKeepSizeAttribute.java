...
public class TableOnUpdateKeepSizeAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "on-update-keep-size" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:on-update-keep-size is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:on-update-keep-size} dependent of its element name
	 * 
