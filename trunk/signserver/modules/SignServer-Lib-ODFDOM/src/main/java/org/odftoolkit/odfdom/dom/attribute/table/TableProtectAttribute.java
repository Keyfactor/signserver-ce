...
public class TableProtectAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "protect" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:protect is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:protect} dependent of its element name
	 * 
