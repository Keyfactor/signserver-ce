...
public class TableRangeUsableAsAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "range-usable-as" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:range-usable-as is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:range-usable-as} dependent of its element name
	 * 
