...
public class TableStructureProtectedAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "structure-protected" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:structure-protected is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:structure-protected} dependent of its element name
	 * 
