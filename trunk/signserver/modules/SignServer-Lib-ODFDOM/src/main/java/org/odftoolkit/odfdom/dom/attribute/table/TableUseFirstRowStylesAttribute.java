...
public class TableUseFirstRowStylesAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "use-first-row-styles" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of table:use-first-row-styles is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute table:use-first-row-styles} dependent of its element name
	 * 
