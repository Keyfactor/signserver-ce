...
public class TextCombineEntriesWithDashAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "combine-entries-with-dash" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:combine-entries-with-dash is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:combine-entries-with-dash} dependent of its element name
	 * 
