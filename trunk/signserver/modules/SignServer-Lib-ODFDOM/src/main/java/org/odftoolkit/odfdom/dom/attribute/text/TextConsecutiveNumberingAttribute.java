...
public class TextConsecutiveNumberingAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "consecutive-numbering" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:consecutive-numbering is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:consecutive-numbering} dependent of its element name
	 * 
