...
public class TextIgnoreCaseAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "ignore-case" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:ignore-case is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:ignore-case} dependent of its element name
	 * 
