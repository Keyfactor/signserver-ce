...
public class TextNumberedEntriesAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "numbered-entries" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:numbered-entries is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:numbered-entries} dependent of its element name
	 * 
