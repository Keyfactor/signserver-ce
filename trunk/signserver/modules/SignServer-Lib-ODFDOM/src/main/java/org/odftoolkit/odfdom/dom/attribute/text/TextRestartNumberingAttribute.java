...
public class TextRestartNumberingAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "restart-numbering" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:restart-numbering is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:restart-numbering} dependent of its element name
	 * 
