...
public class TextRestartOnPageAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "restart-on-page" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:restart-on-page is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:restart-on-page} dependent of its element name
	 * 
