		...
		if( parentElement != null ){
			try {
				if( parentElement instanceof TextPageContinuationElement ){
					super.setValue(TextPageContinuationElement.TextSelectPageAttributeValue.enumValueOf(attrValue).toString());
	...
	public String getValue(){
		...
		if( parentElement != null ){
			try {
				...
				// TODO: validation handling/logging
				throw new NumberFormatException("the value of text:select-page is not valid");
			}
		}else{
			//2DO:what should do when the owner element is null?
