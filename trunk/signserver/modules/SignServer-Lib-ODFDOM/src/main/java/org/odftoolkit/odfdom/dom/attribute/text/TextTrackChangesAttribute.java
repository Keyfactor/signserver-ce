...
public class TextTrackChangesAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "track-changes" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:track-changes is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:track-changes} dependent of its element name
	 * 
