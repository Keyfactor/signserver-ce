...
public class TextUseTablesAttribute extends OdfAttribute {
	...
	public static final OdfName ATTRIBUTE_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TEXT), "use-tables" );
	...
	public String getValue(){
		try{
			...
			// TODO: validation handling/logging
			throw new NumberFormatException("the value of text:use-tables is not valid");
		}
	}
	/**
	 * Returns the default value of {@odf.attribute text:use-tables} dependent of its element name
	 * 
