 ...
 *
 */
public abstract class DbColumnsElement extends OdfElement
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "columns" );
	 ...
	 * @return   return  the element {@odf.element db:column}
	 * DifferentQName 
	 */
    
	public DbColumnElement newDbColumnElement(String dbNameAttributeValue)
	{
		DbColumnElement  dbColumn = ((OdfFileDom)this.ownerDocument).newOdfElement(DbColumnElement.class);
		dbColumn.setDbNameAttribute( dbNameAttributeValue );
