...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "connection-resource" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  DbConnectionResourceElement}
	 *
