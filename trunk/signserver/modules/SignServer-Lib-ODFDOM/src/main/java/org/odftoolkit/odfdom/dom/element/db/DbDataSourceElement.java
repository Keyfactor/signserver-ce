 ...
 *
 */
public abstract class DbDataSourceElement extends OdfElement
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "data-source" );
	 ...
	 *
	 * @return   return  the element {@odf.element db:connection-data}
	 * DifferentQName 
	 */
	 ...
	 *
	 * @return   return  the element {@odf.element db:driver-settings}
	 * DifferentQName 
	 */
	 ...
	 *
	 * @return   return  the element {@odf.element db:application-connection-settings}
	 * DifferentQName 
	 */
