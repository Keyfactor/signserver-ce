...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "indices" );
	 ...
	 * @return   return  the element {@odf.element db:index}
	 * DifferentQName 
	 */
    
	public DbIndexElement newDbIndexElement(String dbNameAttributeValue)
	{
		DbIndexElement  dbIndex = ((OdfFileDom)this.ownerDocument).newOdfElement(DbIndexElement.class);
		dbIndex.setDbNameAttribute( dbNameAttributeValue );
