...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.DB), "schema-definition" );
	 ...
	 *
	 * @return   return  the element {@odf.element db:table-definitions}
	 * DifferentQName 
	 */
