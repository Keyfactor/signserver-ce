...
{        
	 ...
	 * @return   return  the element {@odf.element db:table-definition}
	 * DifferentQName 
	 */
    
	public DbTableDefinitionElement newDbTableDefinitionElement(String dbNameAttributeValue)
	{
		DbTableDefinitionElement  dbTableDefinition = ((OdfFileDom)this.ownerDocument).newOdfElement(DbTableDefinitionElement.class);
		dbTableDefinition.setDbNameAttribute( dbNameAttributeValue );
