...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "formatted-text" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  FormFormattedTextElement}
	 *
	...
	{
		FormSpinButtonAttribute attr = (FormSpinButtonAttribute) getOdfAttribute( OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "spin-button" ) );
		if( attr != null ){
			return Boolean.valueOf( attr.booleanValue() );
		}
	...
	{
		FormValidationAttribute attr = (FormValidationAttribute) getOdfAttribute( OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "validation" ) );
		if( attr != null ){
			return Boolean.valueOf( attr.booleanValue() );
		}
