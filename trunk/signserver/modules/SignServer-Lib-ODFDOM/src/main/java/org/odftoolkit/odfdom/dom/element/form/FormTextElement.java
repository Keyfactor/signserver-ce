...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.FORM), "text" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  FormTextElement}
	 *
