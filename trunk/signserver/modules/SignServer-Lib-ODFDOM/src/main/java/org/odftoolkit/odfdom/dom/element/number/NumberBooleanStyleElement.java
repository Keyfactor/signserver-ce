 ...
 *
 */
public abstract class NumberBooleanStyleElement extends OdfElement
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.NUMBER), "boolean-style" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  NumberBooleanStyleElement}
	 *
	 ...
	 *
	 * @return   return  the element {@odf.element number:boolean}
	 * DifferentQName 
	 */
