...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.NUMBER), "currency-style" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  NumberCurrencyStyleElement}
	 *
	 ...
	 *
	 * @return   return  the element {@odf.element number:currency-symbol}
	 * DifferentQName 
	 */
