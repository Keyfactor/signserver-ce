 ...
 *
 */
public abstract class OfficeBinaryDataElement extends OdfElement
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.OFFICE), "binary-data" );
