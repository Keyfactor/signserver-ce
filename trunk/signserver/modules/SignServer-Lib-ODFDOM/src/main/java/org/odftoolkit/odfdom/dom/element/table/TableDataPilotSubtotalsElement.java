 ...
 *
 */
public abstract class TableDataPilotSubtotalsElement extends OdfElement
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "data-pilot-subtotals" );
	 ...
	 * @return   return  the element {@odf.element table:data-pilot-subtotal}
	 * DifferentQName 
	 */
    
	public TableDataPilotSubtotalElement newTableDataPilotSubtotalElement(String tableFunctionAttributeValue)
	{
		...
		tableDataPilotSubtotal.setTableFunctionAttribute( tableFunctionAttributeValue );
