 ...
 *
 */
public abstract class TableEvenColumnsElement extends OdfStylableElement
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "even-columns" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  TableEvenColumnsElement}
	 *
