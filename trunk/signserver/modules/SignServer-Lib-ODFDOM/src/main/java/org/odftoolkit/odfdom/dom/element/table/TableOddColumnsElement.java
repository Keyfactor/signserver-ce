...
{        
    public static final OdfName ELEMENT_NAME = OdfName.get( OdfNamespace.get(OdfNamespaceNames.TABLE), "odd-columns" );
	...
	/**
	 * Initialization of the mandatory attributes of {@link  TableOddColumnsElement}
	 *
