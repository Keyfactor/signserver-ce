    ...
    protected int goComposite(boolean simulate) throws DocumentException {
        ...
        while (true) {
            ...
            if (element.type() == Element.PARAGRAPH) {
                ...
                org.signserver.lib.itext.text.List list = (org.signserver.lib.itext.text.List)element;
                ...
                for (int k = 0; k < items.size(); ++k) {
                    ...
                    else if (obj instanceof org.signserver.lib.itext.text.List) {
                        stack.push(new Object[]{list, new Integer(k), new Float(listIndentation)});
                        list = (org.signserver.lib.itext.text.List)obj;
                        items = list.getItems();
                    ...
                    if (k == items.size() - 1) {
                        if (!stack.isEmpty()) {
                            ...
                            list = (org.signserver.lib.itext.text.List)objs[0];
                            items = list.getItems();
