 ...
 * <P>
 * When using variable borders ({@link org.signserver.lib.itext.text.Rectangle#isUseVariableBorders isUseVariableBorders()} == true),
 ...
 * cells.
 *
 * @see		org.signserver.lib.itext.text.Rectangle
 * @see		org.signserver.lib.itext.text.Cell
 * @see		PdfLine
 * @see		PdfTable
 */
...
public class PdfCell extends Rectangle {
     ...
     * @param side the side to check.  One of the side constants in {@link org.signserver.lib.itext.text.Rectangle}
