...
import org.signserver.lib.itext.text.pdf.internal.PolylineShape;
...
*/
    ...
    private boolean drawImage(Image img, Image mask, AffineTransform xform, Color bgColor, ImageObserver obs) {
        ...
        try {
            org.signserver.lib.itext.text.Image image = null;
            if(!convertImagesToJPEG){
                image = org.signserver.lib.itext.text.Image.getInstance(img, bgColor);
            }
            else{
                ...
                scaled.flush();
                scaled = null;
                image = org.signserver.lib.itext.text.Image.getInstance(baos.toByteArray());
                
            }
            if (mask!=null) {
                org.signserver.lib.itext.text.Image msk = org.signserver.lib.itext.text.Image.getInstance(mask, null, true);
                msk.makeMask();
    ...
    private void setPaint(boolean invert, double xoffset, double yoffset, boolean fill) {
        if (paint instanceof Color) {
            ...
            try {
                ...
                org.signserver.lib.itext.text.Image image = org.signserver.lib.itext.text.Image.getInstance(img, null);
