...
import org.signserver.lib.itext.text.exceptions.InvalidPdfException;
import org.signserver.lib.itext.text.exceptions.UnsupportedPdfException;
...
public class PdfReader implements PdfViewerPreferences {
    ...
    private void readDecryptedDocObj() throws IOException {
        ...
        if (documentIDs != null) {
            ...
            strings.remove(o);
            s = o.toString();
            documentID = org.signserver.lib.itext.text.DocWriter.getISOBytes(s);
        ...
        if (filter.equals(PdfName.STANDARD)) {
            ...
            uValue = org.signserver.lib.itext.text.DocWriter.getISOBytes(s);
            s = enc.get(PdfName.O).toString();
            strings.remove(enc.get(PdfName.O));
            oValue = org.signserver.lib.itext.text.DocWriter.getISOBytes(s);
