...
public class MechanismNames {
    ...
    static {
        ...
        SIGALGOS2L.put("NONEwithRSAandMGF1", CKM.RSA_PKCS_PSS);
        ...
        SIGALGOS2L.put("NONEwithRSASSA-PSS", CKM.RSA_PKCS_PSS);
        SIGALGOS2L.put("SHA1withRSASSA-PSS", CKM.SHA1_RSA_PKCS_PSS);
        SIGALGOS2L.put("SHA256withRSASSA-PSS", CKM.SHA256_RSA_PKCS_PSS);
        SIGALGOS2L.put("SHA384withRSASSA-PSS", CKM.SHA384_RSA_PKCS_PSS);
        SIGALGOS2L.put("SHA512withRSASSA-PSS", CKM.SHA512_RSA_PKCS_PSS);
