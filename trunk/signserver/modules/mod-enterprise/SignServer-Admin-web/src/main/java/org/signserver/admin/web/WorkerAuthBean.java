...
public class WorkerAuthBean {
    ...
    public void setCertSN(String certSN) {
        this.certSN = StringUtils.trim(certSN);
    }
    ...
    public void setIssuerDN(String issuerDN) {
        this.issuerDN = StringUtils.trim(issuerDN);
    }
    ...
    public void setOldCertSN(String oldCertSN) {
        this.oldCertSN = StringUtils.trim(oldCertSN);
    }
    ...
    public void setOldIssuerDN(String oldIssuerDN) {
        this.oldIssuerDN = StringUtils.trim(oldIssuerDN);
    }
