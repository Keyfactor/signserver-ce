...
public class ApkProvider extends Provider {
    ...
    final static class ApkSignature extends SignatureSpi {
        ...
        protected byte[] engineSign() throws SignatureException {
            ...
            try {
                ...
                return bos.toByteArray();
                     ...
                     SignServerException | IOException | NoSuchAlgorithmException | NoSuchProviderException e) {
        ...
        private byte[] getHashedMessage(final byte[] data)
            ...
            final MessageDigest md = MessageDigest.getInstance(digestName, BouncyCastleProvider.PROVIDER_NAME);
