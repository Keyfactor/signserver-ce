...
/**
 * Reference to an RSA private key for a remote ApkHashSigner.
 *
 * @author Marcus Lundblad
 * @version $Id$
 */
public class ApkRsaPrivateKey extends ApkPrivateKey {
    
    public ApkRsaPrivateKey(final String workerName,
    ...
    public ApkRsaPrivateKey(final int workerId,
                            final DocumentSignerFactory signerFactory,
                            final Map<String, Object> requestContext,
                            final Map<String, String> metadata) {
