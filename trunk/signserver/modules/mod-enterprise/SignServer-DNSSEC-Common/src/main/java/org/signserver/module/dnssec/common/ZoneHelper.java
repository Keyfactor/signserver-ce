...
public class ZoneHelper {
    ...
    public static String toSignatureInput(final byte[] plainText, final String digestAlgorithm) throws NoSuchAlgorithmException, IOException, NoSuchProviderException {
