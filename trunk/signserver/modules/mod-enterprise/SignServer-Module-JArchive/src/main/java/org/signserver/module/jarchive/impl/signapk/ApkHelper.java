...
public class ApkHelper {
     ...
     */
    public static void copyFiles(Manifest manifest, JarFile in, JarOutputStream out, int alignment, boolean keepSignatures, boolean replaceSignature, String signatureName) throws IOException, IllegalRequestException {
        SignApk.copyFiles(manifest, in, out, -1, alignment, keepSignatures, replaceSignature, signatureName);
    }
