...
public class JArchiveSignerUnitTest {
     ...
     */
    @Test
    public void testInit_tsaDigestAlgorithmSHA1() throws Exception {
        LOG.info("testInit_TSA_PASSWORD");
        WorkerConfig config = createConfig();
     ...
     */
    @Test
    public void testInit_tsaDigestAlgorithmSHA256() throws Exception {
        LOG.info("testInit_TSA_PASSWORD");
        WorkerConfig config = createConfig();
     ...
     */
    @Test
    public void testInit_tsaDigestAlgorithmSHA384() throws Exception {
        LOG.info("testInit_TSA_PASSWORD");
        WorkerConfig config = createConfig();
     ...
     */
    @Test
    public void testInit_illegalTsaDigestAlgorithm() throws Exception {
        LOG.info("testInit_TSA_PASSWORD");
        WorkerConfig config = createConfig();
