...
public class MSIUtils {
     ...
     * @throws IOException 
     */
    public static void traverseDirectory(final POIFSFileSystem fs,
    ...
    /**
     * Create an instance of SpcSipInfo suitable for MSI files.
     * 
     * @return SpcSipInfo to use in indirect data content for MSI files.
     */
    public static SpcSipInfo createMSISpcSipInfo() {
        return new SpcSipInfo(new ASN1Integer(1), 
