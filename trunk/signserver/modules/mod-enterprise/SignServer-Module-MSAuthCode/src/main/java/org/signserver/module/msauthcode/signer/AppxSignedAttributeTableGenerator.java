...
/**
 * Signed attributes generator for APPX.
 */
public class AppxSignedAttributeTableGenerator
    implements CMSAttributeTableGenerator
{
    /** Logger for this class */
    private static final Logger LOG = Logger.getLogger(AppxSignedAttributeTableGenerator.class);
    private final Hashtable table;

    /**
     * Initialise to use all defaults
     */
    public AppxSignedAttributeTableGenerator()
    {
        table = new Hashtable();
    }
        ...
        Map parameters)
    {
        ...
        if (!std.containsKey(CMSAttributes.messageDigest))
        {
            ...
            if (LOG.isDebugEnabled()) {
                LOG.debug("SATG MD *****: " + Hex.toHexString(messageDigest));
            }
