...
public class AppxSignerUnitTest {
    ...
    public void testNormalSigning_RSA() throws Exception {
        ...
        try (
            ...
            assertSignedAndNotTimestamped(resp);
        }
    }
    ...
    private void assertSignedAndNotTimestamped(final SignatureResponse res) throws IOException, CMSException, OperatorCreationException {
