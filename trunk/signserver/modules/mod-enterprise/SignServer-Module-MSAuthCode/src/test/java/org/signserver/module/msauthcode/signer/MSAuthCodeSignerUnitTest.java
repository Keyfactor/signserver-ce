...
public class MSAuthCodeSignerUnitTest {
    ...
    public void testNormalSigning_RSA() throws Exception {
        ...
        try (
            ...
            try (
                ...
                assertSignedAndNotTimestamped(tokenRSA, CMSAlgorithm.SHA256, CMSAlgorithm.SHA256, PKCSObjectIdentifiers.sha256WithRSAEncryption, resp, pe);
            }
        }
    }
    ...
    public void testNormalSigning_SHA1WithRSA() throws Exception {
        ...
        try (
            ...
            try (
                    PEFile pe = new PEFile(responseData.toReadableData().getAsFile());) {
                assertSignedAndNotTimestamped(tokenRSA, CMSAlgorithm.SHA256, X509ObjectIdentifiers.id_SHA1, PKCSObjectIdentifiers.rsaEncryption, resp, pe);
            }
        }
    }
    ...
    public void testNormalSigning_DSA() throws Exception {
        ...
        try (
            ...
            try (
                    PEFile pe = new PEFile(responseData.toReadableData().getAsFile());) {
                assertSignedAndNotTimestamped(tokenDSA, CMSAlgorithm.SHA256, CMSAlgorithm.SHA256, ID_SHA256WITHDSA, resp, pe);
            }
        }
    }
    ...
    public void testNormalSigning_digestSHA1() throws Exception {
        ...
        try (
            ...
            try (
                    PEFile pe = new PEFile(responseData.toReadableData().getAsFile());) {
                assertSignedAndNotTimestamped(tokenRSA, X509ObjectIdentifiers.id_SHA1, CMSAlgorithm.SHA256, PKCSObjectIdentifiers.sha256WithRSAEncryption, resp, pe);
            }
    ...
    public void testNormalSigning_digestSHA384() throws Exception {
        ...
        try (
            ...
            SignatureResponse resp = sign(requestData, responseData, tokenRSA, new ConfigBuilder()
                    ...
                    .create(), null, null, null);
            try (PEFile pe = new PEFile(responseData.toReadableData().getAsFile());) {
                assertSignedAndNotTimestamped(tokenRSA, CMSAlgorithm.SHA384, CMSAlgorithm.SHA384, PKCSObjectIdentifiers.sha384WithRSAEncryption, resp, pe);
            }
    ...
    public void testNormalSigning_SHA1WithDSA() throws Exception {
        ...
        try (
            ...
            try (
                    PEFile pe = new PEFile(responseData.toReadableData().getAsFile());) {
                assertSignedAndNotTimestamped(tokenDSA, CMSAlgorithm.SHA256, X509ObjectIdentifiers.id_SHA1, ID_SHA1WITHDSA, resp, pe);
            }
        }
    }
    ...
    public void testNormalSigning_ECDSA() throws Exception {
        ...
        try (
            ...
            try (
                    PEFile pe = new PEFile(responseData.toReadableData().getAsFile());) {
                assertSignedAndNotTimestamped(tokenECDSA, CMSAlgorithm.SHA256, CMSAlgorithm.SHA256, X9ObjectIdentifiers.ecdsa_with_SHA256, resp, pe);
            }
        }
    }
    ...
    public void testNormalSigning_SHA1WithECDSA() throws Exception {
        ...
        try (
            ...
            try (
                    PEFile pe = new PEFile(responseData.toReadableData().getAsFile());) {
                assertSignedAndNotTimestamped(tokenECDSA, CMSAlgorithm.SHA256, X509ObjectIdentifiers.id_SHA1, X9ObjectIdentifiers.ecdsa_with_SHA1, resp, pe);
            }
        }
    }
...
//    }
    ...
    public void testNormalSigningMSI_RSA() throws Exception {
        ...
        try (
            ...
            assertSignedAndNotTimestampedMSI(tokenRSA, "SHA-256", CMSAlgorithm.SHA256, CMSAlgorithm.SHA256, PKCSObjectIdentifiers.sha256WithRSAEncryption, resp, fs);
        }
    }
    ...
    public void testNormalSigningMSI_DSA() throws Exception {
        ...
        try (
            ...
            FileUtils.writeByteArrayToFile(new File("/tmp/test-signed.msi"), responseData.toReadableData().getAsByteArray());
            POIFSFileSystem fs = new POIFSFileSystem(responseData.toReadableData().getAsInputStream());
            assertSignedAndNotTimestampedMSI(tokenDSA, "SHA-256", CMSAlgorithm.SHA256, CMSAlgorithm.SHA256, ID_SHA256WITHDSA, resp, fs);
        }
    }
    ...
    public void testNormalSigningMSI_ECDSA() throws Exception {
        ...
        try (
            ...
            FileUtils.writeByteArrayToFile(new File("/tmp/test-signed.msi"), responseData.toReadableData().getAsByteArray());
            POIFSFileSystem fs = new POIFSFileSystem(responseData.toReadableData().getAsInputStream());
            assertSignedAndNotTimestampedMSI(tokenECDSA, "SHA256", CMSAlgorithm.SHA256, CMSAlgorithm.SHA256, X9ObjectIdentifiers.ecdsa_with_SHA256, resp, fs);
        }
    }
    ...
    public void testNormalSigningMSI_digestSHA256() throws Exception {
        ...
        try (
            ...
            FileUtils.writeByteArrayToFile(new File("/tmp/test-signed.msi"), responseData.toReadableData().getAsByteArray());
            POIFSFileSystem fs = new POIFSFileSystem(responseData.toReadableData().getAsInputStream());
            assertSignedAndNotTimestampedMSI(tokenRSA, "SHA256", CMSAlgorithm.SHA256, CMSAlgorithm.SHA256, PKCSObjectIdentifiers.sha256WithRSAEncryption, resp, fs);
        }
    }
    ...
    public void testNormalSigningMSI_SHA384withRSA() throws Exception {
        ...
        try (
            ...
            FileUtils.writeByteArrayToFile(new File("/tmp/test-signed.msi"), responseData.toReadableData().getAsByteArray());
            POIFSFileSystem fs = new POIFSFileSystem(responseData.toReadableData().getAsInputStream());
            assertSignedAndNotTimestampedMSI(tokenRSA, "SHA-384", CMSAlgorithm.SHA384, CMSAlgorithm.SHA384, PKCSObjectIdentifiers.sha384WithRSAEncryption, resp, fs);
        }
    }
    ...
    public void testNormalSigningMSI_SHA256withECDSA() throws Exception {
        ...
        try (
            ...
            FileUtils.writeByteArrayToFile(new File("/tmp/test-signed.msi"), responseData.toReadableData().getAsByteArray());
            POIFSFileSystem fs = new POIFSFileSystem(responseData.toReadableData().getAsInputStream());
            assertSignedAndNotTimestampedMSI(tokenECDSA, "SHA-256", CMSAlgorithm.SHA256, CMSAlgorithm.SHA256, X9ObjectIdentifiers.ecdsa_with_SHA256, resp, fs);
        }
    }
