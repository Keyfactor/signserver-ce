...
public class MSAuthCodeSignerUnitTest {
    ...
    public void testNormalSigning_RSA() throws Exception {
        ...
        // given
        final ASN1ObjectIdentifier expectedPeDigestAlg = CMSAlgorithm.SHA256;
        final ASN1ObjectIdentifier expectedCmsDigestAlg = CMSAlgorithm.SHA256;
        final ASN1ObjectIdentifier expectedSignatureAlg =
                PKCSObjectIdentifiers.sha256WithRSAEncryption;
        final int expectedNumberOfSignatures = 1;
        ...
        try (
            ...
            try (
                ...
                // then
                assertSignedAndNotTimestamped(tokenRSA, expectedPeDigestAlg,
                        expectedCmsDigestAlg,
                        expectedSignatureAlg,
                        resp, pe,
                        expectedNumberOfSignatures);
            }
        }
    }
    ...
    public void testNormalSigning_SHA1WithRSA() throws Exception {
        ...
        // given
        final ASN1ObjectIdentifier expectedPeDigestAlg = CMSAlgorithm.SHA256;
        final ASN1ObjectIdentifier expectedCmsDigestAlg =
        ...
        try (
            ...
            try (
                    PEFile pe = new PEFile(responseData.toReadableData().getAsFile());) {
                // then
                assertSignedAndNotTimestamped(tokenRSA,
                        expectedPeDigestAlg,
                        expectedCmsDigestAlg,
                        expectedSignatureAlg,
                        resp, pe,
    ...
    public void testNormalSigning_EmptyParams() throws Exception {
        ...
        try (
            ...
            // when
            SignatureResponse resp = sign(requestData, responseData, tokenRSA, new ConfigBuilder()
                    .withSignatureAlgorithm("  ").withDigestAlgorithm("  ").withTimestampFormat("  ").withProgramName("  ").withProgramURL(" ").withProgramName(" ").create(), null, null, null);
            try (
                    PEFile pe = new PEFile(responseData.toReadableData().getAsFile());) {
                // then
                assertSignedAndNotTimestamped(tokenRSA, expectedPeDigestAlg,
                        expectedCmsDigestAlg,
                        expectedSignatureAlg, resp, pe,
                        expectedNumberOfSignatures);
            }
        }
    }
    ...
    public void testNormalSigning_DSA() throws Exception {
        ...
        final ASN1ObjectIdentifier expectedPeDigestAlg = CMSAlgorithm.SHA256;
        final ASN1ObjectIdentifier expectedCmsDigestAlg = CMSAlgorithm.SHA256;
        final ASN1ObjectIdentifier expectedSignatureAlg = ID_SHA256WITHDSA;
        final int expectedNumberOfSignatures = 1;
        ...
        try (
            ...
            try (
                    PEFile pe = new PEFile(responseData.toReadableData().getAsFile());) {
                // then
                assertSignedAndNotTimestamped(tokenDSA, expectedPeDigestAlg,
                                              expectedCmsDigestAlg,
                                              expectedSignatureAlg, resp, pe,
                                              expectedNumberOfSignatures);
            }
    ...
    public void testNormalSigning_digestSHA1() throws Exception {
        ...
        // given
        final ASN1ObjectIdentifier expectedPeDigestAlg =
                X509ObjectIdentifiers.id_SHA1;
        final ASN1ObjectIdentifier expectedCmsDigestAlg = CMSAlgorithm.SHA256;
        final ASN1ObjectIdentifier expectedSignatureAlg =
                PKCSObjectIdentifiers.sha256WithRSAEncryption;
    ...
    public void testNormalSigning_digestSHA256() throws Exception {
        ...
        try (
            ...
            SignatureResponse resp = sign(requestData, responseData, tokenRSA, new ConfigBuilder()
                    ...
                    .withProgramURL("http://www.signserver.org/junit/test.html")
                    .create(), null, null, null);
            try (PEFile pe = new PEFile(responseData.toReadableData().getAsFile());) {
                // then
                assertSignedAndNotTimestamped(tokenRSA, expectedPeDigestAlg,
                        expectedCmsDigestAlg,
                        expectedSignatureAlg,
    ...
    public void testNormalSigning_digestSHA384() throws Exception {
        ...
        // given
        final ASN1ObjectIdentifier expectedPeDigestAlg = CMSAlgorithm.SHA384;
        final ASN1ObjectIdentifier expectedCmsDigestAlg = CMSAlgorithm.SHA384;
        final ASN1ObjectIdentifier expectedSignatureAlg =
    ...
    public void testNormalSigning_SHA1WithDSA() throws Exception {
        ...
        final ASN1ObjectIdentifier expectedCmsDigestAlg =
                X509ObjectIdentifiers.id_SHA1;
        final ASN1ObjectIdentifier expectedSignatureAlg = ID_SHA1WITHDSA;
        final int expectedNumberOfSignatures = 1;
    ...
    public void testNormalSigning_ECDSA() throws Exception {
        ...
        try (
            ...
            try (
                    PEFile pe = new PEFile(responseData.toReadableData().getAsFile());) {
                // then
                assertSignedAndNotTimestamped(tokenECDSA, expectedPeDigestAlg,
                        expectedCmsDigestAlg,
                        expectedSignatureAlg,
                        resp, pe,
                        expectedNumberOfSignatures);
    ...
    /**
     * Test that signing an already signed PE file works, and adds the
     * new signature as expected.
     *
     * @throws Exception
     */
    @Test
    public void testSigningAlreadySigned() throws Exception {
        ...
        final ASN1ObjectIdentifier expectedSignatureAlg =
                PKCSObjectIdentifiers.sha256WithRSAEncryption;
        final int expectedNumberOfSignatures = 2;

        // Fist check that test file already has a signature
        try (final PEFile peOriginal = new PEFile(executableFileWithSignature);) {
        ...
        try (CloseableReadableData requestData = ModulesTestCase.createRequestDataKeepingFile(executableFileWithSignature);
             CloseableWritableData responseData = ModulesTestCase.createResponseData(true);){
            // when
            SignatureResponse resp = signData(requestData, responseData, tokenRSA,
                    new ConfigBuilder()
                            .withProgramName("SignServer-JUnit-Test-åäö")
                            .withProgramURL("http://www.signserver.org/junit/test.html")
                            .create(), null, null, null);
    ...
    public void testProgramNameOverride_defaultsMSI() throws Exception {
        ...
        try (
            ...
            SignatureResponse resp = sign(requestData, responseData, tokenRSA, new ConfigBuilder()
                    ...
                    .withProgramURL("http://www.signserver.org/junit/test.html")
                    .create(), null, null, null);
            try (POIFSFileSystem fs = new POIFSFileSystem(responseData.toReadableData().getAsFile());) {
    ...
    public void testNormalSigningMSI_RSA() throws Exception {
        ...
        // given
        final ASN1ObjectIdentifier expectedMsiDigestAlg = CMSAlgorithm.SHA256;
        final ASN1ObjectIdentifier expectedCmsDigestAlg = CMSAlgorithm.SHA256;
        final ASN1ObjectIdentifier expectedSignatureAlg =
                PKCSObjectIdentifiers.sha256WithRSAEncryption;
        final int expectedNumberOfSignatures = 1;
        ...
        try (
            ...
            try (
                    MSIFile msiFile1 = new MSIFile(responseData.toReadableData().getAsFile())
            ) {
                // then
                assertSignedAndNotTimestampedMSI(tokenRSA, expectedMsiDigestAlg,
                        expectedCmsDigestAlg,
                        expectedSignatureAlg,
                        resp, msiFile1,
                        expectedNumberOfSignatures);
    ...
    public void testNormalSigningMSI_DSA() throws Exception {
        ...
        try (
            ...
            try (
                ...
                // then
                assertSignedAndNotTimestampedMSI(tokenDSA, expectedMsiDigestAlg,
                        expectedCmsDigestAlg,
                        expectedSignatureAlg,
                        resp, msiFile1,
                        expectedNumberOfSignatures);
    ...
    public void testNormalSigningMSI_ECDSA() throws Exception {
        ...
        try (
            ...
            try (
                ...
                // then
                assertSignedAndNotTimestampedMSI(tokenECDSA, expectedMsiDigestAlg,
                        expectedCmsDigestAlg,
                        expectedSignatureAlg,
                        resp, msiFile1,
                        expectedNumberOfSignatures);
    ...
    public void testNormalSigningMSI_digestSHA256() throws Exception {
        ...
        try (
            ...
            SignatureResponse resp = sign(requestData, responseData, tokenRSA, new ConfigBuilder()
                    ...
                    .create(), null, null, null);
            FileUtils.writeByteArrayToFile(new File("/tmp/test-signed.msi"), responseData.toReadableData().getAsByteArray());
            try (MSIFile msiFile1 = new MSIFile(responseData.toReadableData().getAsFile());) {
                // then
                assertSignedAndNotTimestampedMSI(tokenRSA, expectedMsiDigestAlg,
                        expectedCmsDigestAlg,
                        expectedSignatureAlg,
     ...
     */
    @Test
    public void testNormalSigningMSI_SHA384withRSA() throws Exception {
        LOG.info("testNormalSigningMSI_SHA384withRSA");
        // given
        final ASN1ObjectIdentifier expectedMsiDigestAlg = CMSAlgorithm.SHA384;
        final ASN1ObjectIdentifier expectedCmsDigestAlg = CMSAlgorithm.SHA384;
        final ASN1ObjectIdentifier expectedSignatureAlg =
                PKCSObjectIdentifiers.sha384WithRSAEncryption;
        final int expectedNumberOfSignatures = 1;
    ...
    public void testSignAlreadySignedMSI() throws Exception {
        ...
        final int expectedNumberOfSignatures = 2;
        // Fist check that test file already has a signature
        try (final MSIFile msiOriginal = new MSIFile(msiFileWithSignature)) {
            if (msiOriginal.getSignatures().size() != 1) {
                throw new Exception("Test expect the test file already have one signature but was " + msiOriginal.getSignatures().size());
            }
        }
        ...
        try (
            ...
            // when
            SignatureResponse resp = sign(requestData, responseData, tokenRSA,
                    new ConfigBuilder()
                            .withProgramName("SignServer-JUnit-Test-åäö")
                            .withProgramURL("http://www.signserver.org/junit/test.html")
                            .create(), null, null, null);
    ...
    /**
     * Tests that an incorrect TSA_URL gives a SignServerException.
     * @throws Exception
     */
    @Test
    public void testIncorrectTSAURL_msi() throws Exception {
        LOG.info("testIncorrectTSAURL_msi");
        try (
                CloseableReadableData requestData = ModulesTestCase.createRequestDataKeepingFile(msiFile);
                CloseableWritableData responseData = ModulesTestCase.createResponseData(true);
        ) {
            signData(requestData, responseData, tokenRSA, new ConfigBuilder()
                    .withProgramName("SignServer-JUnit-Test-åäö")
                    .withProgramURL("http://www.signserver.org/junit/test.html")
                    .withTsaUrl("http://localhost:8080/non-existing")
                    .create(), null, null, null);
            fail("Expected failure because of TSA_URL");
     ...
     */
    @Test
    public void testIncorrectTSAURL_pe() throws Exception {
        LOG.info("testIncorrectTSAURL_pe");
        try (
                CloseableReadableData requestData = ModulesTestCase.createRequestDataKeepingFile(executableFile);
                CloseableWritableData responseData = ModulesTestCase.createResponseData(true);
        ) {
    ...
    private void assertSignedAndNotTimestampedMSI(MockedCryptoToken token,
                                                  ASN1ObjectIdentifier msiDigestAlg,
                                                  ASN1ObjectIdentifier cmsDigestAlgOID,
                                                  ASN1ObjectIdentifier sigAlgOID,
                                                  SignatureResponse res, MSIFile msiFile1,
                                                  final int expectedNumberOfSignatures) throws Exception {
        List<CMSSignedData> signatures = msiFile1.getSignatures();
        assertEquals("Number of signatures", expectedNumberOfSignatures,
                signatures.size());

        // Reconstruct the data "to be signed"
        DigestAlgorithm digestAlg = DigestAlgorithm.of(msiDigestAlg);
        byte[] digest = msiFile1.computeDigest(digestAlg.getMessageDigest());
        ASN1ObjectIdentifier digestAlgOID =
                new ASN1ObjectIdentifier(msiDigestAlg.getId());
        ...
        final net.jsign.asn1.authenticode.SpcIndirectDataContent spcIndirectDataContent =
                new net.jsign.asn1.authenticode.SpcIndirectDataContent(
                        new SpcAttributeTypeAndOptionalValue(AuthenticodeObjectIdentifiers.SPC_SIPINFO_OBJID, sipInfo),
                        new DigestInfo(new AlgorithmIdentifier(digestAlgOID), digest));
        ...
        // use the latest added signature
        final CMSSignedData signedData =
                new CMSSignedData(new CMSProcessableByteArray(content),
                        signatures.get(expectedNumberOfSignatures - 1)
                                .getEncoded());
    ...
    private void assertSignedAndNotTimestamped(MockedCryptoToken token,
                                               ASN1ObjectIdentifier peDigestAlg,
                                               ASN1ObjectIdentifier cmsDigestAlgOID,
                                               ASN1ObjectIdentifier sigAlgOID,
                                               SignatureResponse res, PEFile pe,
                                               final int expectedNumberOfSignatures) throws Exception {
    ...
    private String getProgramName(final CMSSignedData signedData) {
        ...
        // Check program name
        ASN1TaggedObject programNameObject = (ASN1TaggedObject) seq.getObjectAt(0);

        String actualProgramName = null;
        if (programNameObject.getTagNo() == 0) {
            if (((ASN1TaggedObject)programNameObject.getObject()).getTagNo() == 0) {
                // unicode
                actualProgramName = DERBMPString.getInstance((ASN1TaggedObject) programNameObject.getObject(), false).getString();
            } else if (((ASN1TaggedObject)programNameObject.getObject()).getTagNo() == 1) {
                // ascii
                actualProgramName = DERIA5String.getInstance((ASN1TaggedObject) programNameObject.getObject(), false).getString();
            } else {
    ...
    private String getProgramURL(final CMSSignedData signedData) {
        ...
        // Check program name
        ASN1TaggedObject programURLObject =
                (ASN1TaggedObject) seq.getObjectAt(seq.size() > 1 ? 1 : 0);
