...
public class EjbcaWSCAConnector implements ICAConnector {
    ...
    private String createRequestPEM(String subjectDN, PrivateKey privateKey, PublicKey publicKey, String provider) throws IOException {
        final PKCS10CertReqInfo certReqInfo = new PKCS10CertReqInfo(certSignatureAlgorithm, subjectDN, null);
        
        AbstractCertReqData reqData = (AbstractCertReqData) CryptoTokenHelper.genCertificateRequest(certReqInfo, privateKey, provider, publicKey, false);
