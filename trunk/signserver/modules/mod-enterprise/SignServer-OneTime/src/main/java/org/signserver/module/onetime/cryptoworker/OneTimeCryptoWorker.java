...
public class OneTimeCryptoWorker extends CryptoWorker {
    ...
    public void init(final int workerId, final WorkerConfig config, 
        ...
        // This worker requires key generation
        if (SignServerUtil.isKeyGenerationDisabled()) {
            configErrors.add("Key generation is disabled.");
        }
    ...
    @Override
    protected ICryptoInstance acquireDefaultCryptoInstance(final Map<String, Object> params,
                                                           final String alias,
                                                           final RequestContext context)
