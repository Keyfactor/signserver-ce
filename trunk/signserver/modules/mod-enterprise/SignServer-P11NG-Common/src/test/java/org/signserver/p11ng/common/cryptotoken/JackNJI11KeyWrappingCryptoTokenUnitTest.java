...
/**
 * Unit tests for the JackNJI11KeyWrappingCryptoToken.
 *  
 * @author Marcus Lundblad
 * @version $Id$
 */
public class JackNJI11KeyWrappingCryptoTokenUnitTest extends TestCase {
    ...
    public void testInit_sharedLibraryNameRequired() throws Exception {
        final JackNJI11KeyWrappingCryptoToken instance =
                new JackNJI11KeyWrappingCryptoToken();
    ...
    public void testInit_slotLabelTypeRequired() throws Exception {
        ...
        try {
            ...
            assertTrue("Should mention missing SLOTLABEL_TYPE",
