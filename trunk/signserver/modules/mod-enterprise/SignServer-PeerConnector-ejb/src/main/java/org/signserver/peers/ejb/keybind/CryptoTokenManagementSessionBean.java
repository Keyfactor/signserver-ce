...
public class CryptoTokenManagementSessionBean implements CryptoTokenManagementSessionLocal {
    ...
    @Override
    public boolean isCryptoTokenPresent(AuthenticationToken at, int i) throws AuthorizationDeniedException {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    @Override
    public List<String> isCryptoTokenSlotUsed(AuthenticationToken at, String string, String string1, Properties prprts) throws AuthorizationDeniedException, CryptoTokenNameInUseException, CryptoTokenOfflineException, CryptoTokenAuthenticationFailedException, NoSuchSlotException {
        throw new UnsupportedOperationException("Not supported yet.");
    }
