...
public class QoSFilterUnitTest {
     ...
     */
    @Test
    public void globalPropertiesCachedAtInit() throws ServletException {
        // given
        ...
        // when
        filter.init(new MockedFilterConfig(), createMockedServices());
        // then
        assertEquals(
     ...
     */
    @Test
    public void globalPropertiesNotRecreated() throws Exception {
        // given
     ...
     */
    @Test
    public void globalPropertyCached() throws Exception {
        // given
     ...
     */
    @Test
    public void globalPropertyCacheRecreated() throws InterruptedException, ServletException {
        // given
        // after (immediately) setting a property value, cache should not have been recreated
        ...
        assertEquals("Number of cache recreations",
                ...
                filter.getNumberOfCacheRecreations());
        assertEquals("Expected proper cache size", expectedCacheSizeBeforeTimeout, filter.getCacheMapSize());
        // when
        ...
        assertEquals("Expected proper cache size", expectedCacheSizeAfterTimeout, filter.getCacheMapSize());
    }
    ...
    private IServices createMockedServices() {
        final ServicesImpl services = new ServicesImpl();
        services.put(GlobalConfigurationSessionLocal.class, new GlobalConfigurationSessionMock());
        services.put(WorkerSessionLocal.class, new WorkerSessionMock());
        return services;
    }
