...
public class DocumentSignerClientsideBatchTest extends ModulesTestCase {
    ...
    public void setUp() throws Exception {
        ...
        setupSSLKeystores();
        sampleFile1 = new File(signserverhome + File.separator + "res" +
                               File.separator + "test" + File.separator +
                               "HelloPE.exe");
        sampleFile2 = new File(signserverhome + File.separator + "res" +
                               File.separator + "test" + File.separator +
                               "sample.msi");
        signedPE = new File(signserverhome + File.separator + "res" +
                               File.separator + "test" + File.separator +
                               "HelloPE-signed.exe");
        signedMSI = new File(signserverhome + File.separator + "res" +
                               File.separator + "test" + File.separator +
                               "sample-signed.msi");
    ...
    /**
     * Tests that signing already signed PE file fails.
     * <pre>
     * signdocument -workername XMLSigner -indir /tmp/input -outdir /tmp/output
     * </pre>
     * @throws Exception
     */
    @Test
    public void test05sign1DocumentFromInDir_Signed_PE() throws Exception {
        LOG.info("test05sign1DocumentFromInDir_Signed_PE");
        inDir.create();
        FileUtils.copyFileToDirectory(signedPE, inDir.getRoot());
        outDir.create();
    ...
    /**
     * Tests that signing already signed MSI file fails.
     * <pre>
     * signdocument -workername XMLSigner -indir /tmp/input -outdir /tmp/output
     * </pre>
     * @throws Exception
