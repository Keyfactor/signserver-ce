...
public class ExtendedCMSSignerTest extends ModulesTestCase {
    ...
    public void testSigningWithInternalTSA(final boolean clientSide,
        ...
        try {
            ...
            signAndAssertOk(time, clientSide, messageDigestParam, hashDigestAlgo);
        } finally {
    ...
    private void signAndAssertOk(final Date timestamp,
        ...
        final GenericSignResponse res =
                (GenericSignResponse) processSession.process(new WorkerIdentifier(ExtendedCMSSignerTest.WORKER_ID), signRequest, requestContext);
