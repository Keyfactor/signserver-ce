...
public class MSAuthCodeSignerP11Test {
    ...
    /**
     * Test signing CAT using PKCS#11 token.
     * 
     * @throws Exception 
     */
    @Test
    public void testSigningCatUsingP11() throws Exception {
        LOG.info("testSigningCatUsingP11");
        testSigningUsingP11(FileType.CAT);
    }
        ...
        try {
            ...
            switch (fileType) {
                ...
                case PS1:
                    ...
                    break;
                case CAT:
                    signedBinary = MSAuthCodeSignerTest.signAndAssertOkCat(catFile, WORKER_ID, TS_ID, time, false, 1);
                    break;
                default:
