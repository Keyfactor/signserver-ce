        ...
        try {
            ...
            switch (fileType) {
                ...
                case PE:
                    ...
                    break;
                case APPX:
                    signedBinary = MSAuthCodeSignerTest.signAndAssertOkAPPX(appxFile, WORKER_ID, TS_ID, time, false, false, workerSession.getSignerCertificate(new WorkerIdentifier(WORKER_ID)));
                    break;
                default:
