...
public class TimeMonitorRunnableTest extends TestCase {
    ...
    /**
     * Test that an error message received after a configuration change is
     * logged, even though the report state was UNKNOWN before the change.
     * 
     * @throws java.lang.Exception
     */
    @Test
    public void testLogErrorAfterConfigChange() throws Exception {
        LOG.info("logErrorAfterConfigChange");
        ...
        MockTimeMonitorRunnable instance = new MockTimeMonitorRunnable(appConfig, runConfig) {
            ...
            @Override
            protected NTPDateResult queryTask() {
                return new NTPDateResult(1, "20 Jun 09:12:41 ntpdate[15324]: no server suitable for synchronization found",
                        "server1", 16, 0.01, 0.02, false);
            }

            @Override
            protected LeapState leapTask(final NTPQResult ntpQ) {
                return LeapState.NONE;
            }
        ...
        // Make sure an error is logged
        instance.errorLog = new StringBuilder();
        instance.runRound();
        assertEquals("Command failed (stratum: 16, exit: 1): 20 Jun 09:12:41 ntpdate[15324]: no server suitable for synchronization found",
                instance.errorLog.toString());

        // No configuration change, an error shouldn't be logged
        instance.errorLog = new StringBuilder();
        instance.runRound();
        assertEquals("", instance.errorLog.toString());

        // Create a new runConfig, an error message should be logged
        instance.setNewRunConfig(TimeMonitorRuntimeConfig.load(getRunProperties(), errors));
        instance.errorLog = new StringBuilder();
        instance.runRound();
        assertEquals("Command failed (stratum: 16, exit: 1): 20 Jun 09:12:41 ntpdate[15324]: no server suitable for synchronization found",
                instance.errorLog.toString());
    ...
    /**
     * Test that two consecutive error messages are logged, given that they
     * are different.
     * 
     * @throws java.lang.Exception
     */
    @Test
    public void testLogErrorMessageChange() throws Exception {
        LOG.info("logErrorMessageChange");
        ...
        MockTimeMonitorRunnable instance = new MockTimeMonitorRunnable(appConfig, runConfig) {
            ...
            protected NTPDateResult queryTask() {
                ...
                switch (message) {
                    case 1:
                        return new NTPDateResult(1, "Error resolving abc: No address associated with hostname (-5)\n20 Jun 13:14:23 ntpdate[24862]: Can't find host abc: No address associated with hostname (-5)\n20 Jun 13:14:23 ntpdate[24862]: no servers can be used, exiting",
                                "server1", 16, 0.01, 0.02, false);
                    case 2:
                        return new NTPDateResult(1, "Error resolving abc: No address associated with hostname (-5)\n1 Jul 14:15:24 ntpdate[12345]: Can't find host abc: No address associated with hostname (-5)\n1 Jul 14:15:24 ntpdate[12345]: no servers can be used, exiting",
                                "server1", 16, 0.01, 0.02, false);
                    case 3:
                        return new NTPDateResult(1, "20 Jun 09:12:41 ntpdate[15324]: no server suitable for synchronization found",
                                "server1", 16, 0.01, 0.02, false);
        ...
        instance.errorLog = new StringBuilder();
        instance.runRound();
        assertEquals("Command failed (stratum: 16, exit: 1): Error resolving abc: No address associated with hostname (-5)\n20 Jun 13:14:23 ntpdate[24862]: Can't find host abc: No address associated with hostname (-5)\n20 Jun 13:14:23 ntpdate[24862]: no servers can be used, exiting",
                instance.errorLog.toString());

        // Same error message with different time/PID info, no error should be logged
        instance.errorLog = new StringBuilder();
        instance.runRound();
        assertEquals("", instance.errorLog.toString());

        // New error message, make sure an error is logged
        instance.errorLog = new StringBuilder();
        instance.runRound();
        assertEquals("Command failed (stratum: 16, exit: 1): 20 Jun 09:12:41 ntpdate[15324]: no server suitable for synchronization found",
                instance.errorLog.toString());
